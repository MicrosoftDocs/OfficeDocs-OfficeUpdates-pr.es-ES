...
> - Microsoft Teams está incluido en las nuevas instalaciones del canal semestral para empresas (versión preliminar), empezando por la versión 1902. Se agregará Teams a las instalaciones existentes del canal semestral para empresas (versión preliminar) cuando se actualicen a la versión 1908 o posterior. Para obtener más información, vea [Implementar Microsoft Teams con Office 365 ProPlus](https://docs.microsoft.com/DeployOffice/teams-install).
...
- **Instalación de Microsoft Teams:** se ha agregado Teams a las instalaciones existentes de Office 365 ProPlus. [Más información](https://docs.microsoft.com/DeployOffice/teams-install)
