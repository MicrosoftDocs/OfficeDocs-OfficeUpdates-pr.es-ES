...
### <a name="powerpoint-feature-updates"></a>PowerPoint: actualizaciones de características
 ...
 - **Microsoft Forms:** colocar un cuestionario o una encuesta en una diapositiva. Office recopila y almacena las respuestas para usted. [Más información](https://support.office.com/article/1a316f81-9ea7-4bc2-bda0-024c0d780df1)
...
-   **Tenga sincronizados los diagramas y los orígenes:** al editar un diagrama del Visualizador de datos en Visio, tiene la opción de actualizar los datos de origen de Excel vinculados con el contenido más reciente de un diagrama.
...
-   Se muestra la presencia del usuario como "Sin conexión" cuando este no se encuentra en una reunión, se deshabilitó de Skype for Business y la experiencia de unirse a una reunión se establece en Cliente limitado nativo.
-   Se deshabilitan todas las opciones, excepto Abrir y Salir, cuando Skype for Business se minimiza en el área de notificación. 
