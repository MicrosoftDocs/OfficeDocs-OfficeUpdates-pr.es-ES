...
### <a name="excel"></a><span data-ttu-id="511dc-126">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-126">Excel</span></span>
...
### <a name="word"></a><span data-ttu-id="511dc-154">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-154">Word</span></span>
...
### <a name="office-suite"></a><span data-ttu-id="511dc-210">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-210">Office Suite</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="511dc-224">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-224">PowerPoint</span></span>
...
### <a name="outlook"></a><span data-ttu-id="511dc-256">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-256">Outlook</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="511dc-284">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-284">PowerPoint</span></span>
...
### <a name="onenote"></a><span data-ttu-id="511dc-301">OneNote</span><span class="sxs-lookup"><span data-stu-id="511dc-301">OneNote</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="511dc-328">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-328">PowerPoint</span></span>
...
- <span data-ttu-id="511dc-343">Se ha corregido un problema por el que seleccionar un rango de celdas en una hoja daba lugar a la selección de una sola celda.</span><span class="sxs-lookup"><span data-stu-id="511dc-343">Fixed an issue where selecting a range of cells on a sheet would result in the selection of a single cell.</span></span>
...
### <a name="project"></a><span data-ttu-id="511dc-382">Project</span><span class="sxs-lookup"><span data-stu-id="511dc-382">Project</span></span>
...
- <span data-ttu-id="511dc-420">Este cambio corrige retrasos al procesar imágenes con información de protocolo mal formada o incorrecta.</span><span class="sxs-lookup"><span data-stu-id="511dc-420">This change addresses delays when processing images with malformed or invalid protocol information.</span></span>
...
### <a name="word"></a><span data-ttu-id="511dc-435">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-435">Word</span></span>
...
### <a name="project"></a><span data-ttu-id="511dc-450">Proyecto</span><span class="sxs-lookup"><span data-stu-id="511dc-450">Project</span></span>
...
### <a name="powerpoint"></a><span data-ttu-id="511dc-467">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-467">PowerPoint</span></span>
...
- <span data-ttu-id="511dc-489">Se ha corregido un problema en el que el texto de una segmentación de datos no se escala correctamente en la vista previa de impresión.</span><span class="sxs-lookup"><span data-stu-id="511dc-489">Fixed an issue where text in a slicer isn't scaled properly in Print Preview.</span></span>

### <a name="outlook"></a><span data-ttu-id="511dc-490">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-490">Outlook</span></span>

- <span data-ttu-id="511dc-491">Corrige un problema que causaba que la fecha de "última modificación" de un archivo se actualizara al agregar un archivo adjunto a un correo electrónico o al guardar un archivo adjunto desde un correo arrastrándolo y colocándolo (en lugar de hacerlo a través de un menú).</span><span class="sxs-lookup"><span data-stu-id="511dc-491">Addresses an issue that caused the "Last Modified" date on a file to be updated when adding an attachment to a mail or saving an attachment from a mail by dragging and dropping it (as opposed to via a menu).</span></span>

### <a name="word"></a><span data-ttu-id="511dc-492">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-492">Word</span></span>

- <span data-ttu-id="511dc-493">Se ha corregido un problema por el que al ir a la tarjeta del comentario, el foco en el cuadro de edición del comentario no era visible.</span><span class="sxs-lookup"><span data-stu-id="511dc-493">Fixed an issue that when tabbing through a comment card, the focus on the comment edit box would not be visible.</span></span>

- <span data-ttu-id="511dc-494">Si se inserta un control (como un control de contenido de texto) en una ecuación, al guardar y abrir el archivo se produce un error de contenido ilegible.</span><span class="sxs-lookup"><span data-stu-id="511dc-494">Inserting a control (such as a Text Content Control) in an equation then saving and opening the file results in an un-readable content error.</span></span>

- <span data-ttu-id="511dc-495">Se ha corregido un problema que hacía que no se pudiera guardar un archivo protegido con contraseña anteriormente en un almacenamiento en la nube.</span><span class="sxs-lookup"><span data-stu-id="511dc-495">Fixed an issue where saving a previously password protected file to a cloud storage would not work.</span></span>

### <a name="office-suite"></a><span data-ttu-id="511dc-496">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-496">Office Suite</span></span>

- <span data-ttu-id="511dc-497">Corrige un problema por el que cuando hay varios documentos abiertos en Word/Excel/PowerPoint de la misma biblioteca de SharePoint, solo se analizará el primer documento abierto para el cumplimiento de las directivas.</span><span class="sxs-lookup"><span data-stu-id="511dc-497">Fixes an issue when multiple documents are open in Word/Excel/PowerPoint from the same SharePoint library, only the first document opened will be scanned for Policy compliance.</span></span>

[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)

## <a name="version-2003-february-21"></a><span data-ttu-id="511dc-499">Versión 2003: 21 de febrero</span><span class="sxs-lookup"><span data-stu-id="511dc-499">Version 2003: February 21</span></span>
<span data-ttu-id="511dc-500">*Versión 2003 (compilación 12615.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-500">*Version 2003 (Build 12615.20000)*</span></span>

[//]: # (NO QUITAR OPCIONES DETALLES CONTENIDO INICIO)

### <a name="feature-updates"></a><span data-ttu-id="511dc-502">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-502">Feature updates</span></span>
### <a name="office-suite"></a><span data-ttu-id="511dc-503">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-503">Office Suite</span></span>

- <span data-ttu-id="511dc-504">**Elija el color perfecto:** use códigos de colores hexadecimales para elegir exactamente el color que desea para la fuente, el resaltado de texto, etc.</span><span class="sxs-lookup"><span data-stu-id="511dc-504">**Pick the perfect color:** Use hex color codes to choose exactly the color you want for your font, text highlight, and more.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-507">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-507">Resolved issues</span></span>

### <a name="excel"></a><span data-ttu-id="511dc-508">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-508">Excel</span></span>
- <span data-ttu-id="511dc-509">Se ha corregido un problema que los usuarios pueden haber experimentado al cambiar el nombre de las medidas de tabla dinámica.</span><span class="sxs-lookup"><span data-stu-id="511dc-509">Fixed an issue that users may have experienced when renaming pivot table measures.</span></span>
- <span data-ttu-id="511dc-510">Se ha corregido un problema de rendimiento que los usuarios pueden haber experimentado al usar una macro de VBA para borrar el contenido de un rango.</span><span class="sxs-lookup"><span data-stu-id="511dc-510">Fixed a performance issue that users may have experienced when using a VBA macro to clear the contents of a range.</span></span>
- <span data-ttu-id="511dc-511">Se ha corregido un problema que provocaba que la interfaz de usuario parpadeara cuando un usuario ejecutaba una macro que interactuaba con la cinta de opciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-511">Fixed an issue that caused the UI to flash when users executed a macro that interacted with the ribbon.</span></span>
- <span data-ttu-id="511dc-512">Se ha corregido un problema por el que los archivos CSV se cargaban de forma incorrecta cuando la primera palabra del archivo estaba era TABLE.</span><span class="sxs-lookup"><span data-stu-id="511dc-512">Fixed an issue where CSV files were loaded incorrectly when the first word in the file was TABLE.</span></span>
- <span data-ttu-id="511dc-513">Se ha corregido un problema por el que los usuarios pueden haber sufrido bloqueos al cambiar entre dos libros que tienen diferentes niveles de zoom.</span><span class="sxs-lookup"><span data-stu-id="511dc-513">Fixed an issue where users may have experienced crashes when switching between two workbooks that had different zoom levels.</span></span>

### <a name="outlook"></a><span data-ttu-id="511dc-514">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-514">Outlook</span></span>
- <span data-ttu-id="511dc-515">Se ha corregido un problema que provocaba que los usuarios no puedan abrir mensajes de la carpeta pública cuando Outlook se dejaba en marcha durante la noche.</span><span class="sxs-lookup"><span data-stu-id="511dc-515">Addressed an issue that caused users to be unable to open public folder messages when Outlook was left running overnight.</span></span>
- <span data-ttu-id="511dc-516">Se ha corregido una condición en la que los botones "Permitir" y "Denegar" de la página de permisos se deshabilitan durante el flujo de trabajo de autenticación para agregar una cuenta de Gmail.</span><span class="sxs-lookup"><span data-stu-id="511dc-516">Fixed a race condition where the 'Allow' and 'Deny' buttons on the permissions page are disabled during the authentication workflow of adding a Gmail account.</span></span>
- <span data-ttu-id="511dc-517">Se ha corregido un problema que hizo que Outlook generara inesperadamente resultados de registro en algunas situaciones, incluso cuando el registro se desactivaba.</span><span class="sxs-lookup"><span data-stu-id="511dc-517">Addressed an issue that caused Outlook to unexpectedly generate logging output in some scenarios, even when logging was turned off.</span></span>

### <a name="word"></a><span data-ttu-id="511dc-518">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-518">Word</span></span>
- <span data-ttu-id="511dc-519">Se ha corregido un problema en el que las tarjetas con comentario no siempre se resaltan cuando se desplaza el puntero del mouse sobre la tarjeta del comentario.</span><span class="sxs-lookup"><span data-stu-id="511dc-519">Fixed an issue where comment cards don't always get highlighted when a mouse pointer hovers over the comment card.</span></span>
- <span data-ttu-id="511dc-520">Durante una sesión de coautoría de documentos activos, agregar una imagen directamente en una tarjeta de comentario puede dar como resultado la adición de una etiqueta.</span><span class="sxs-lookup"><span data-stu-id="511dc-520">During an active document co-authoring session, adding an image directly in to a comment card may result in the addition of a tag.</span></span> <span data-ttu-id="511dc-521">Este problema se ha corregido.</span><span class="sxs-lookup"><span data-stu-id="511dc-521">This issue has been fixed.</span></span>

### <a name="office-suite"></a><span data-ttu-id="511dc-522">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-522">Office Suite</span></span>
- <span data-ttu-id="511dc-523">Al usar las propiedades Multichoice/Lookup/Managed-metadata con documentos de Word/Excel/PowerPoint y guardar en una biblioteca de documentos de SharePoint, estas propiedades se limitaban anteriormente a 255 caracteres.</span><span class="sxs-lookup"><span data-stu-id="511dc-523">When using Multichoice/Lookup/Managed-metadata properties with Word/Excel/PowerPoint documents and saving to a SharePoint Document Library, these properties were previously limited to 255 characters.</span></span> <span data-ttu-id="511dc-524">Cuando estas propiedades superaban 255 caracteres, estos documentos no se podían guardar.</span><span class="sxs-lookup"><span data-stu-id="511dc-524">When these properties exceeded 255 characters, such documents could not be saved.</span></span> <span data-ttu-id="511dc-525">Con este cambio, este límite se ha aumentado a 2048 caracteres.</span><span class="sxs-lookup"><span data-stu-id="511dc-525">With this change, this limit has been increased to 2048 characters.</span></span>

[//]: # (NO QUITAR DETALLES DE ERROR DEL CONTENIDO FINAL)

## <a name="version-2003-february-14"></a><span data-ttu-id="511dc-527">Versión 2003: 14 de febrero</span><span class="sxs-lookup"><span data-stu-id="511dc-527">Version 2003: February 14</span></span>
<span data-ttu-id="511dc-528">*Versión 2003 (compilación 12607.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-528">*Version 2003 (Build 12607.20000)*</span></span>

[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)

### <a name="feature-updates"></a><span data-ttu-id="511dc-530">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-530">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="511dc-531">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-531">Outlook</span></span>

- <span data-ttu-id="511dc-532">**Nueva experiencia para redes WiFi cautivas:** ¿alguna vez se ha unido a una red WiFi que requiere una página web para iniciar sesión?</span><span class="sxs-lookup"><span data-stu-id="511dc-532">**New experience for captive wifi networks:** Have you ever joined a wifi network that required a web page to sign in with?</span></span> <span data-ttu-id="511dc-533">Outlook ahora lo detecta y le ayuda a estar conectado.</span><span class="sxs-lookup"><span data-stu-id="511dc-533">Outlook now detects this and helps you get connected.</span></span>

### <a name="word"></a><span data-ttu-id="511dc-534">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-534">Word</span></span>

- <span data-ttu-id="511dc-535">**Busque el editor de entrada de lápiz en el cuadro de herramientas de dibujo:** seleccione Dibujar y seleccione el lápiz del editor de entrada de lápiz para editar el documento con el dedo o un lápiz digital.</span><span class="sxs-lookup"><span data-stu-id="511dc-535">**Find Ink Editor in your drawing toolbox:** Select Draw and then choose the Ink Editor pen to edit your document with your finger or a digital pen.</span></span> [<span data-ttu-id="511dc-536">Más información</span><span class="sxs-lookup"><span data-stu-id="511dc-536">Learn more</span></span>](https://support.office.com/article/7edbcf8e-0004-484d-9b62-501a31c23ee9)

### <a name="office-suite"></a><span data-ttu-id="511dc-537">Conjunto de programas de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-537">Office Suite</span></span>

- <span data-ttu-id="511dc-538">**Iconos de la barra de estado más nítidos:** los iconos de la barra de estado ahora son más fáciles de ver</span><span class="sxs-lookup"><span data-stu-id="511dc-538">**Clearer status bar icons:** Status bar icons are now easier to see</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-541">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-541">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="511dc-542">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-542">Outlook</span></span>

- <span data-ttu-id="511dc-543">Se ha corregido un problema que provocaba que los usuarios perdieran el acceso al cuadro de diálogo de permisos de calendario "opciones de disponibilidad".</span><span class="sxs-lookup"><span data-stu-id="511dc-543">Addressed an issue that caused users to lose access to the "Free Busy Options" calendar permissions dialog.</span></span>

- <span data-ttu-id="511dc-544">Se ha corregido un problema que podría provocar la alerta: "lo sentimos, tenemos problemas para abrir este elemento" al abrir algunas instancias de reuniones periódicas que se han enviado desde una zona horaria diferente.</span><span class="sxs-lookup"><span data-stu-id="511dc-544">Fixed an issue that may result in the alert: "Sorry we're having trouble opening this item" when opening some recurring meeting instances sent from a different time zone.</span></span>

- <span data-ttu-id="511dc-545">Se ha corregido un problema que podría ocasionar que los usuarios no puedan abrir un archivo .msg después de arrastrar y soltar datos adjuntos desde el mensaje.</span><span class="sxs-lookup"><span data-stu-id="511dc-545">Addressed an issue that could cause users to be unable to reopen a .msg file after dragging and dropping an attachment from that message.</span></span>

- <span data-ttu-id="511dc-546">Se ha corregido un problema por el que, después de cargar un archivo adjunto desde Outlook a OneDrive, se podía cambiar el nombre de archivo si el nombre de los datos adjuntos contenía paréntesis.</span><span class="sxs-lookup"><span data-stu-id="511dc-546">Fixed an issue where after uploading a file attachment from Outlook to OneDrive could result in the file name being changed if the attachment's name contained parenthesis.</span></span>

### <a name="powerpoint"></a><span data-ttu-id="511dc-547">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-547">PowerPoint</span></span>

- <span data-ttu-id="511dc-548">Se ha corregido un problema que podría provocar un error al guardar un documento en PowerPoint o en Word con un gráfico de Excel.</span><span class="sxs-lookup"><span data-stu-id="511dc-548">Fixed an issue that could result in a failure to save a document in PowerPoint or Word containing an Excel chart.</span></span>

### <a name="word"></a><span data-ttu-id="511dc-549">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-549">Word</span></span>

- <span data-ttu-id="511dc-550">Se ha corregido un problema por el que las imágenes de los documentos pierden transparencia al exportarse a PDF.</span><span class="sxs-lookup"><span data-stu-id="511dc-550">Fixed an issue where pictures in documents lose transparency when exported to PDF.</span></span>

[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)

## <a name="version-2002-february-07"></a><span data-ttu-id="511dc-552">Versión 2002: 07 de febrero</span><span class="sxs-lookup"><span data-stu-id="511dc-552">Version 2002: February 07</span></span>
<span data-ttu-id="511dc-553">*Versión 2002 (Compilación 12527.20040)*</span><span class="sxs-lookup"><span data-stu-id="511dc-553">*Version 2002 (Build 12527.20040)*</span></span>

[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)

### <a name="feature-updates"></a><span data-ttu-id="511dc-555">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-555">Feature updates</span></span>
### <a name="access"></a><span data-ttu-id="511dc-556">Access</span><span class="sxs-lookup"><span data-stu-id="511dc-556">Access</span></span>

- <span data-ttu-id="511dc-557">**Aumente su productividad con el Diseñador de consultas, la vista SQL y la ventana Relaciones:** haga clic con el botón derecho en una tabla para abrirla, diseñarla, cambiar su tamaño y ocultarla.</span><span class="sxs-lookup"><span data-stu-id="511dc-557">**Be more productive working in Query Designer, SQL view, and the Relationships window:** Right-click a table to open, design, size, and hide it.</span></span> <span data-ttu-id="511dc-558">Buscar y reemplazar texto en la vista SQL.</span><span class="sxs-lookup"><span data-stu-id="511dc-558">Search and replace text in SQL View.</span></span> <span data-ttu-id="511dc-559">Seleccione múltiples tablas en la ventana Relaciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-559">Select multiple tables in the Relationships window.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-562">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-562">Resolved issues</span></span>
### <a name="access"></a><span data-ttu-id="511dc-563">Access</span><span class="sxs-lookup"><span data-stu-id="511dc-563">Access</span></span>

- <span data-ttu-id="511dc-564">Esta actualización corrige un problema por el que al usar un objeto de grabación de ADODB</span><span class="sxs-lookup"><span data-stu-id="511dc-564">This update fixes an issue where using an ADODB.</span></span> <span data-ttu-id="511dc-565">en el código de VB, se puede notificar un error incorrectamente.</span><span class="sxs-lookup"><span data-stu-id="511dc-565">Recorder object in VB code may incorrectly report an error.</span></span>

- <span data-ttu-id="511dc-566">Esta actualización corrige un problema que puede hacer que Microsoft Access no identifique una Columna de identidad en una tabla vinculada de SQL Server, lo que puede provocar que las filas aparezcan como eliminadas de forma incorrecta.</span><span class="sxs-lookup"><span data-stu-id="511dc-566">This update fixes an issue that can cause Microsoft Access to fail to identify an Identity Column in a linked SQL Server table, which can cause rows to be reported as deleted incorrectly.</span></span>

### <a name="excel"></a><span data-ttu-id="511dc-567">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-567">Excel</span></span>

- <span data-ttu-id="511dc-568">Se ha corregido un problema por el que Excel se bloquea al usar la opción Texto a columnas con matrices dinámicas.</span><span class="sxs-lookup"><span data-stu-id="511dc-568">Fixed an issue where Excel would crash when using Text To Columns with dynamic arrays.</span></span>

### <a name="outlook"></a><span data-ttu-id="511dc-569">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-569">Outlook</span></span>

- <span data-ttu-id="511dc-570">Se ha corregido un problema en el que el desplazamiento en el calendario con la vista de mes no muestra eventos de calendario anteriores.</span><span class="sxs-lookup"><span data-stu-id="511dc-570">Fixed an issue where scrolling in calendar with month view, fails to show previous calendar events.</span></span>

- <span data-ttu-id="511dc-571">Corrige un problema que causaba que los usuarios sufrieran un error al visualizar más de 30 calendarios en un entorno Citrix.</span><span class="sxs-lookup"><span data-stu-id="511dc-571">Addresses an issue that caused users to experience a crash when viewing more than 30 calendars in a Citrix environment.</span></span>

### <a name="powerpoint"></a><span data-ttu-id="511dc-572">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-572">PowerPoint</span></span>

- <span data-ttu-id="511dc-573">Se ha corregido un problema que provocaba que, después de cerrar un archivo, PowerPoint no lo quitara inmediatamente de la colección Presentaciones si había algún controlador de eventos en ejecución.</span><span class="sxs-lookup"><span data-stu-id="511dc-573">Fixed an issue where after closing a file, PowerPoint does not immediately remove it from the Presentations collection if there are any event handlers running.</span></span> <span data-ttu-id="511dc-574">Por lo tanto, el número de presentaciones que informa el modelo de objetos es incorrecto y se evita el cierre de PowerPoint.</span><span class="sxs-lookup"><span data-stu-id="511dc-574">Hence the number of open presentations reported by the object model is incorrect, and shutdown of PowerPoint is prevented.</span></span>

- <span data-ttu-id="511dc-575">Se ha corregido un problema con el marcador de resaltado: los textos blancos con un marcador oscuro se imprimen como negros en escala de grises.</span><span class="sxs-lookup"><span data-stu-id="511dc-575">Fixed an issue with highlighter : White texts with dark highlighter colors are printed as black in Grayscale.</span></span>

### <a name="word"></a><span data-ttu-id="511dc-576">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-576">Word</span></span>

- <span data-ttu-id="511dc-577">Al actualizar y desplazarse por una tabla de contenido, es posible que se muestre un área gris en el documento.</span><span class="sxs-lookup"><span data-stu-id="511dc-577">Updating and scrolling through a table of contents may sometimes display a gray area over the document.</span></span>

- <span data-ttu-id="511dc-578">Se ha corregido un problema por el que si se trabajaba en coautoría en un documento, la versión de borrador de un comentario raíz podía no conservarse.</span><span class="sxs-lookup"><span data-stu-id="511dc-578">Fixed an issue where if a document is being coauthored, the draft version of a root comment may not be preserved.</span></span>

- <span data-ttu-id="511dc-579">Se ha corregido un problema por el que al ir de una tarjeta de comentario a otra se podía mostrar el comentario seleccionado inicialmente con una selección resaltada.</span><span class="sxs-lookup"><span data-stu-id="511dc-579">Fixed an issue where going back and forth between comment cards would sometimes display the initially selected comment with a selection highlight.</span></span>

- <span data-ttu-id="511dc-580">Se ha corregido un problema por el que usar "Examinar" para guardar un archivo podía no funcionar si se escribió un comentario sin publicarlo y el usuario intentó guardar el archivo.</span><span class="sxs-lookup"><span data-stu-id="511dc-580">Fixed an issue where using 'Browse' to save a file did not work if a comment was written but not posted and the user tried to save the file.</span></span>

- <span data-ttu-id="511dc-581">Con el Control de cambios habilitado y el panel de comentarios cerrado, Ctrl + Alt + M podía no funcionar para abrir el panel Comentarios.</span><span class="sxs-lookup"><span data-stu-id="511dc-581">With SlideTrack enabled and the comments pane closed, Ctrl+Alt+M may not open the comments pane.</span></span>

- <span data-ttu-id="511dc-582">Corregido un problema al agregar una @mención en una tabla que podía generar el mensaje de error: "Una tabla de este documento está dañada".</span><span class="sxs-lookup"><span data-stu-id="511dc-582">Fixed an issue when adding @mention in a table could generate the error message: 'A table in this document has become corrupted'.</span></span>

### <a name="office-suite"></a><span data-ttu-id="511dc-583">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-583">Office Suite</span></span>

- <span data-ttu-id="511dc-584">Resuelto un problema que podía causar que el paquete de herramientas de corrección de Noruega Nynorsk (NN-no) no se instalara correctamente.</span><span class="sxs-lookup"><span data-stu-id="511dc-584">Resolves an issue that may have caused Norway Nynorsk (nn-no) proofing tools package to be installed incorrectly.</span></span>

[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)


<span data-ttu-id="511dc-586">[Vie 5/29/2020]: Página recortada de Insider Fast eliminando el contenido siguiente.</span><span class="sxs-lookup"><span data-stu-id="511dc-586">[Fri 5/29/2020] - Trimmed Insider Fast page by deleting the following content.</span></span>

## <a name="version-2002-january-31"></a><span data-ttu-id="511dc-587">Versión 2002: 31 de enero</span><span class="sxs-lookup"><span data-stu-id="511dc-587">Version 2002: January 31</span></span>
<span data-ttu-id="511dc-588">*Versión 2002 (compilación 12513.20010)*</span><span class="sxs-lookup"><span data-stu-id="511dc-588">*Version 2002 (Build 12513.20010)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-590">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-590">Feature updates</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-591">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-591">Excel</span></span>
 
- <span data-ttu-id="511dc-592">\*\*Lea y responda sobre la marcha: \*\*responda a los comentarios y las menciones directamente desde el correo electrónico sin abrir el libro.</span><span class="sxs-lookup"><span data-stu-id="511dc-592">**Read and reply on the fly:** Respond to comments and mentions right from email without opening the workbook.</span></span>
 
- <span data-ttu-id="511dc-593">**Perfiles de datos en el editor de consultas:** analice rápidamente los datos de las columnas, identifique errores y valores vacíos, vea histogramas de distribución y mucho más.</span><span class="sxs-lookup"><span data-stu-id="511dc-593">**Data Profiling in Query Editor:** Get-a-glance analysis of the data in your columns, identify error and empty values, see distribution histograms and more.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-596">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-596">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="511dc-597">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-597">Outlook</span></span>
 
- <span data-ttu-id="511dc-598">Se ha corregido un problema por el que los mensajes de correo electrónico que expiraban en función de una directiva de retención mostraban dos etiquetas.</span><span class="sxs-lookup"><span data-stu-id="511dc-598">Fixed an issue where emails expiring based on a retention policy would display two labels.</span></span> <span data-ttu-id="511dc-599">Una mostraba que el correo expiraba en un día y otra que expiraba en dos días.</span><span class="sxs-lookup"><span data-stu-id="511dc-599">One showing that the mail will expire in one day and another displaying that it will expire in two days.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-600">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-600">Word</span></span>
 
- <span data-ttu-id="511dc-601">Se ha corregido un problema por el que la sugerencia de comentario no se veía en el modo lectura con el color de página &quot;invertido&quot;.</span><span class="sxs-lookup"><span data-stu-id="511dc-601">Fixed an issue where comment hint was not visible in read mode with &quot;Inverse&quot; page color.</span></span>
 
- <span data-ttu-id="511dc-602">Se ha corregido un problema por el que el formato de cursiva se perdía después de editar un comentario, ponerlo en cursiva y, después, publicarlo.</span><span class="sxs-lookup"><span data-stu-id="511dc-602">Fixed an issue where italics formatting is lost after editing a comment, italicizing the text and then posting it.</span></span>
 
- <span data-ttu-id="511dc-603">Se ha corregido un problema por el que los comandos de comentario (Modificar comentario, Responder a comentario, Eliminar comentario, Resolver comentario) en el menú contextual de comentarios no se mostraban.</span><span class="sxs-lookup"><span data-stu-id="511dc-603">Fixed an issue where comment commands (Edit comment, Reply to comment, Delete comment, Resolve comment) in the comments context menu were not being displayed.</span></span>
 
[//]: # (NO QUITAR DETALLES DE ERROR DEL CONTENIDO FINAL)
 
## <a name="version-2002-january-17"></a><span data-ttu-id="511dc-605">Versión 2002: 17 de enero</span><span class="sxs-lookup"><span data-stu-id="511dc-605">Version 2002: January 17</span></span>
<span data-ttu-id="511dc-606">*Versión 2002 (compilación 12508.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-606">*Version 2002 (Build 12508.20000)*</span></span>
 
[//]: # (NO QUITAR OPCIONES DETALLES CONTENIDO INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-608">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-608">Feature updates</span></span>
### <a name="word"></a><span data-ttu-id="511dc-609">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-609">Word</span></span>
 
- <span data-ttu-id="511dc-610">**Correos electrónicos de notificación de menciones y comentarios ahora incluyen vistas previas:** las notificaciones por correo electrónico de menciones y comentarios incluirán ahora vistas previas del texto del comentario y del contexto de lo al que hace referencia.</span><span class="sxs-lookup"><span data-stu-id="511dc-610">**Mention & comment notification emails now contain previews:** Email notifications for mentions & comments will now include previews of the comment text and context for what it is referring to.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-613">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-613">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-614">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-614">Excel</span></span>
 
- <span data-ttu-id="511dc-615">En algunos casos, el Comprobador de accesibilidad no mostraba las recomendaciones para las formas.</span><span class="sxs-lookup"><span data-stu-id="511dc-615">In some cases, the Accessibility checker would not show the recommendations for shapes.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="511dc-616">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-616">Outlook</span></span>
 
- <span data-ttu-id="511dc-617">Las carpetas guardadas en "favoritos" en el panel de navegación izquierdo podían desaparecer de forma esporádica.</span><span class="sxs-lookup"><span data-stu-id="511dc-617">Folders saved in 'Favorites' in the left navigation pane may intermittently disappear.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-618">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-618">PowerPoint</span></span>
 
- <span data-ttu-id="511dc-619">Se ha corregido un problema por el que la entrada de lápiz no se procesaba por completo u se omitía al usarla en una animación de entrada de lápiz de PowerPoint.</span><span class="sxs-lookup"><span data-stu-id="511dc-619">Fixed an issue where Ink may not render completely or get skipped when used in a PowerPoint ink animations.</span></span>
 
[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)
 
## <a name="version-2001-january-10"></a><span data-ttu-id="511dc-621">Versión 2001: 10 de enero</span><span class="sxs-lookup"><span data-stu-id="511dc-621">Version 2001: January 10</span></span>
<span data-ttu-id="511dc-622">*Versión 2001 (compilación 12430.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-622">*Version 2001 (Build 12430.20000)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-624">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-624">Feature updates</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-625">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-625">Excel</span></span>
- <span data-ttu-id="511dc-626">**Guarde formas como imágenes:** con tan solo unos pocos clics, guarde una forma, icono u otro objeto como archivo de imagen para que pueda volver a usarlo en otro lugar.</span><span class="sxs-lookup"><span data-stu-id="511dc-626">**Save shapes as pictures:** In just a few clicks, save a shape, icon, or other object as a picture file so you can reuse it elsewhere.</span></span> [<span data-ttu-id="511dc-627">Más información</span><span class="sxs-lookup"><span data-stu-id="511dc-627">Learn more</span></span>](https://support.office.com/article/3c4f9ca4-945a-4c33-af91-d10e4e3ea715)
 
### <a name="outlook"></a><span data-ttu-id="511dc-628">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-628">Outlook</span></span>
- <span data-ttu-id="511dc-629">**Ahora, el usuario puede guardar objetos en Word/Excel/Outlook como una imagen para Windows:** con la capacidad ya observada en PowerPoint, los usuarios ahora pueden guardar objetos en Word, Excel y Outlook como una imagen.</span><span class="sxs-lookup"><span data-stu-id="511dc-629">**User can now save objects in Word/Excel/Outlook as a picture for Windows.:** With the ability already seen in PowerPoint, users can now save objects in Word, Excel and Outlook as a picture.</span></span> <span data-ttu-id="511dc-630">Entre los objetos se incluyen formas, iconos, imágenes ¡y mucho más!</span><span class="sxs-lookup"><span data-stu-id="511dc-630">Objects include shapes, icons, pictures, and more!</span></span> <span data-ttu-id="511dc-631">Se puede acceder a él a través del menú contextual.</span><span class="sxs-lookup"><span data-stu-id="511dc-631">This can be accessed through the right-click menu.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-632">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-632">Word</span></span>
- <span data-ttu-id="511dc-633">**Seleccione fácilmente entradas de lápiz en Word dibujando una forma alrededor:** la herramienta Lasso en la pestaña Dibujar le ayuda a seleccionar objetos dibujados a mano.</span><span class="sxs-lookup"><span data-stu-id="511dc-633">**Easily select ink in Word by drawing a shape around it.:** The Lasso tool on the Draw tab helps you select objects drawn with ink.</span></span> <span data-ttu-id="511dc-634">Seleccione trazos individuales o palabras completas.</span><span class="sxs-lookup"><span data-stu-id="511dc-634">Select individual strokes, or whole words.</span></span> <span data-ttu-id="511dc-635">Es útil cuando tiene una gran cantidad de trazos y solo desea trabajar con algunos de ellos.</span><span class="sxs-lookup"><span data-stu-id="511dc-635">It's handy when you have lots of ink and you only want to work with some of it.</span></span> [<span data-ttu-id="511dc-636">Más información</span><span class="sxs-lookup"><span data-stu-id="511dc-636">Learn more</span></span>](https://support.office.com/article/6d76c674-7f4b-414d-b67f-b3ffef6ccf53)
 
- <span data-ttu-id="511dc-637">**Guarde formas como imágenes:** con tan solo unos pocos clics, guarde una forma, icono u otro objeto como archivo de imagen para que pueda volver a usarlo en otro lugar.</span><span class="sxs-lookup"><span data-stu-id="511dc-637">**Save shapes as pictures:** In just a few clicks, save a shape, icon, or other object as a picture file so you can reuse it elsewhere.</span></span> [<span data-ttu-id="511dc-638">Más información</span><span class="sxs-lookup"><span data-stu-id="511dc-638">Learn more</span></span>](https://support.office.com/article/3c4f9ca4-945a-4c33-af91-d10e4e3ea715)
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-641">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-641">Resolved issues</span></span>
### <a name="onenote"></a><span data-ttu-id="511dc-642">OneNote</span><span class="sxs-lookup"><span data-stu-id="511dc-642">OneNote</span></span>
- <span data-ttu-id="511dc-643">Las pestañas de la página pueden parecer demasiado pequeñas y juntas en una resolución al 100%.</span><span class="sxs-lookup"><span data-stu-id="511dc-643">Page tabs may appear too small and close together at 100% resolution.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-644">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-644">Word</span></span>
- <span data-ttu-id="511dc-645">En un conjunto de comentarios amplio, al eliminar un comentario cerca del final de la lista de comentarios, es posible que el panel se desplace hasta la parte superior.</span><span class="sxs-lookup"><span data-stu-id="511dc-645">In a large set of comments, deleting a comment near the end of the list of comments may result in the pane scrolling all the way to the top.</span></span>
 
[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)
 
## <a name="version-2001-january-03"></a><span data-ttu-id="511dc-647">Versión 2001: 03 de enero</span><span class="sxs-lookup"><span data-stu-id="511dc-647">Version 2001: January 03</span></span>
<span data-ttu-id="511dc-648">*Versión 2001 (compilación 12425.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-648">*Version 2001 (Build 12425.20000)*</span></span>
 
[//]: # (NO QUITAR ERRORES DETALLES CONTENIDO INICIO)
 
### <a name="resolved-issues"></a><span data-ttu-id="511dc-650">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-650">Resolved issues</span></span>
 
### <a name="excel"></a><span data-ttu-id="511dc-651">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-651">Excel</span></span>
- <span data-ttu-id="511dc-652">Es posible que algunas líneas de borde no se impriman como se espera en papel de tamaño A4.</span><span class="sxs-lookup"><span data-stu-id="511dc-652">Some border lines may not print as expected on A4 size paper.</span></span>
- <span data-ttu-id="511dc-653">Agregar una imagen al encabezado o pie de página de un objeto de gráfico en una hoja con VBA puede provocar un error.</span><span class="sxs-lookup"><span data-stu-id="511dc-653">Adding an image to the header/footer of a chart object on a sheet using VBA may result in an error.</span></span>
- <span data-ttu-id="511dc-654">Al dar formato a un eje del gráfico, el intervalo entre las etiquetas estaba limitado a 255.</span><span class="sxs-lookup"><span data-stu-id="511dc-654">When formatting a chart axis, the interval between labels was limited to 255.</span></span>
- <span data-ttu-id="511dc-655">Se ha corregido un problema que ocurría al intentar actualizar una consulta XML en la que se había acortado la dirección URL del origen de datos.</span><span class="sxs-lookup"><span data-stu-id="511dc-655">Fixed an issue where an error would occur trying to refresh an XML query in which the URL to the datasource was being truncated.</span></span>
- <span data-ttu-id="511dc-656">Las estadísticas del libro notificaban un recuento de macros de todos los libros abiertos, incluido el libro de macros personal.</span><span class="sxs-lookup"><span data-stu-id="511dc-656">Workbook Statistics would report a macro count from all open workbooks, including the personal macro workbook.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="511dc-657">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-657">Outlook</span></span>
- <span data-ttu-id="511dc-658">Cambiar carpetas puede dar lugar a una breve luz blanca en la lista de correo y en la vista previa del correo.</span><span class="sxs-lookup"><span data-stu-id="511dc-658">Switching folders may result in a brief white 'flash' in the mail list / mail preview.</span></span> <span data-ttu-id="511dc-659">Este comportamiento se nota más en el modo oscuro.</span><span class="sxs-lookup"><span data-stu-id="511dc-659">This behavior was more pronounced in dark mode.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-660">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-660">PowerPoint</span></span>
- <span data-ttu-id="511dc-661">Se ha corregido un problema con el modelo de objetos por el que al llamar al método Shape.Paste la forma pegada recibía el foco.&nbsp;</span><span class="sxs-lookup"><span data-stu-id="511dc-661">Fixed an Object Model issue where calling Shape.Paste method would result in the pasted shape receiving focus.&nbsp;</span></span>
- <span data-ttu-id="511dc-662">Se ha mejorado un escenario de copiado y pegado:&nbsp;Copiar mediante programación una forma de una diapositiva de PowerPoint y pegarla en otra diapositiva en un bucle podía producir un error de excepción.&nbsp;</span><span class="sxs-lookup"><span data-stu-id="511dc-662">Improved a copy-paste scenario:&nbsp;Progamatically copying a shape from a PowerPoint slide and pasting it to another slide in a loop could fail with an exception error.&nbsp;</span></span>
- <span data-ttu-id="511dc-663">La animación en la sección encabezados de diapositivas no se representaba correctamente después de contraer y expandir los encabezados de sección.</span><span class="sxs-lookup"><span data-stu-id="511dc-663">Animation in the section headers of slides would not render properly after collapsing and expanding section headers.</span></span>
 
### <a name="project"></a><span data-ttu-id="511dc-664">Project</span><span class="sxs-lookup"><span data-stu-id="511dc-664">Project</span></span>
- <span data-ttu-id="511dc-665">Se ha corregido un problema por el que el ajuste de texto no funcionaba en las vistas de tareas y de uso de recursos.</span><span class="sxs-lookup"><span data-stu-id="511dc-665">Fixed an issue where text wrapping wasn't working in the task and resource usage views.</span></span>
- <span data-ttu-id="511dc-666">Se ha corregido un problema por el que si un recurso tiene más de una tasa de coste, el valor de coste en las tareas podía no ser correcto.</span><span class="sxs-lookup"><span data-stu-id="511dc-666">Fixed an issue where if a resource has more than one cost rate, cost value on assignments may not be correct.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-667">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-667">Word</span></span>
- <span data-ttu-id="511dc-668">Si se insertaba un control (como un control de contenido de texto) en una ecuación, al guardar y abrir el archivo se producía un error de contenido ilegible.</span><span class="sxs-lookup"><span data-stu-id="511dc-668">Inserting a control (such as a Text Content Control) in an equation, then saving and opening the file would result in an un-readable content error.</span></span>
- <span data-ttu-id="511dc-669">Al agregar un comentario con Word Online en coautoría, este podía no aparecer en el escritorio de Word.</span><span class="sxs-lookup"><span data-stu-id="511dc-669">When co-authoring, adding a comment using Word online may not appear in Word desktop.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-670">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-670">Office Suite</span></span>
- <span data-ttu-id="511dc-671">Se ha quitado una fecha de expiración incorrecta de la licencia válida al intentar cambiar la licencia solo con una licencia.</span><span class="sxs-lookup"><span data-stu-id="511dc-671">Removed showing an erroneous expiry date of the valid license when trying to change license with only one license.</span></span>
 
[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)
 
## <a name="version-2001-december-13"></a><span data-ttu-id="511dc-673">Versión 2001: 13 de diciembre</span><span class="sxs-lookup"><span data-stu-id="511dc-673">Version 2001: December 13</span></span>
<span data-ttu-id="511dc-674">*Versión 2001 (Compilación 12410.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-674">*Version 2001 (Build 12410.20000)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-676">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-676">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="511dc-677">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-677">Outlook</span></span>
 
- <span data-ttu-id="511dc-678">**Arrastre el correo electrónico a un grupo de tu propiedad:** Mueva y copie mensajes y conversaciones arrastrándolos desde su bandeja de entrada.</span><span class="sxs-lookup"><span data-stu-id="511dc-678">**Drag email to a group you own:** Move and copy messages and conversations by dragging them from your inbox.</span></span> <span data-ttu-id="511dc-679">Los mensajes que arrastres serán compartidos con todos los miembros del grupo.</span><span class="sxs-lookup"><span data-stu-id="511dc-679">Messages you drag will be shared with all group members.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-682">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-682">Resolved issues</span></span>
### <a name="access"></a><span data-ttu-id="511dc-683">Access</span><span class="sxs-lookup"><span data-stu-id="511dc-683">Access</span></span>
- <span data-ttu-id="511dc-684">La ejecución de una consulta de unión que hace referencia a una(s) tabla(s) ODBC enlazada(s) y que contiene una cláusula de Ordenar por que bloquea el acceso de 64 bits.</span><span class="sxs-lookup"><span data-stu-id="511dc-684">Executing a union query that references linked ODBC table(s) and contains an Order By clause crashes 64 bit Access.</span></span>
- <span data-ttu-id="511dc-685">La suma de los datos de las consultas sindicales en Access (O365) puede resultar en el truncamiento de los datos decimales.</span><span class="sxs-lookup"><span data-stu-id="511dc-685">Summing of data from union queries in Access (O365) may result in truncation of decimal data.</span></span>
- <span data-ttu-id="511dc-686">Las interfaces COM para ACE no están expuestas para su uso fuera de las aplicaciones de Office.</span><span class="sxs-lookup"><span data-stu-id="511dc-686">COM Interfaces for ACE are not exposed for use outside of Office applications.</span></span>
 
### <a name="excel"></a><span data-ttu-id="511dc-687">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-687">Excel</span></span>
- <span data-ttu-id="511dc-688">Al insertar un modelo 3D (animado o estático) e intentar el "Guardar como imagen" no funciona.</span><span class="sxs-lookup"><span data-stu-id="511dc-688">Inserting a 3D model (animated or static) and trying to 'Save as Picture' doesn't work.</span></span>
- <span data-ttu-id="511dc-689">La tecla corta (Alt+Ctrl + 7/8) para lanzar la retroalimentación desde el backstage está en conflicto con los teclados AZERTY (Alt-Gr + 7/8).</span><span class="sxs-lookup"><span data-stu-id="511dc-689">The shortkey (Alt+Ctrl + 7/8)  to launch feedback from backstage is in conflict with AZERTY keyboards (Alt-Gr + 7/8).</span></span> <span data-ttu-id="511dc-690">Impacto: los usuarios puede+ que no sean capaces de utilizar algunos caracteres como: "\'.</span><span class="sxs-lookup"><span data-stu-id="511dc-690">Impact: users may not be able to use some characters such as: '\'.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="511dc-691">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-691">Outlook</span></span>
- <span data-ttu-id="511dc-692">Resuelve un problema que provocó que el correo electrónico se enviara a la dirección incorrecta del destinatario.</span><span class="sxs-lookup"><span data-stu-id="511dc-692">Addresses an issue that caused email to be sent to the wrong address for the recipient.</span></span>
- <span data-ttu-id="511dc-693">Resuelve un problema que hizo que Outlook permitiera incorrectamente a los usuarios con acceso de &quot;lectura&quot; a un buzón de correo cambiar el estado de lectura/no lectura de un mensaje.</span><span class="sxs-lookup"><span data-stu-id="511dc-693">Addresses an issue that caused Outlook to incorrectly allow users with &quot;read&quot; access to a mailbox to change the read/unread state of a message.</span></span>
- <span data-ttu-id="511dc-694">La revocación del certificado de seguridad en el sitio web no es producible por el Soporte de producto.</span><span class="sxs-lookup"><span data-stu-id="511dc-694">The revocation of the security certificate on the web site is not re-producible by Product Support.</span></span> <span data-ttu-id="511dc-695">Es necesario añadir el registro para ayudar a solucionar el problema.</span><span class="sxs-lookup"><span data-stu-id="511dc-695">Logging needs to be added to help root cause the issue.</span></span>
- <span data-ttu-id="511dc-696">Resuelve un problema que hizo que los usuarios vieran fallos de sincronización.</span><span class="sxs-lookup"><span data-stu-id="511dc-696">Addresses an issue that caused users to see synchronization failures.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-697">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-697">PowerPoint</span></span>
- <span data-ttu-id="511dc-698">Al insertar un modelo 3D (animado o estático) e intentar el "Guardar como imagen" no funciona.</span><span class="sxs-lookup"><span data-stu-id="511dc-698">Inserting a 3D model (animated or static) and trying to 'Save as Picture' doesn't work.</span></span>
 
### <a name="project"></a><span data-ttu-id="511dc-699">Project</span><span class="sxs-lookup"><span data-stu-id="511dc-699">Project</span></span>
- <span data-ttu-id="511dc-700">El trabajo de tareas no se calcula en la distribución de resumen para tareas secundarias programadas manualmente.</span><span class="sxs-lookup"><span data-stu-id="511dc-700">Task work is not calculated in Summary roll-up for manually scheduled child tasks.</span></span>
- <span data-ttu-id="511dc-701">Es posible que el código VBA de Project invocado desde un botón de la cinta no funcione cuando se intente guardar proyectos basados en el servidor.</span><span class="sxs-lookup"><span data-stu-id="511dc-701">Project VBA Code invoked from a Ribbon button may not work when trying to save server-based Projects.</span></span>
- <span data-ttu-id="511dc-702">A menos que Project ya se esté ejecutando, al abrir Archivos de Project desde una biblioteca de documentos de SharePoint se mostrará un error y el archivo no se abrirá.</span><span class="sxs-lookup"><span data-stu-id="511dc-702">Unless Project is already running, opening Project files from a SharePoint document library displays an error and the file will not open.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-703">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-703">Word</span></span>
- <span data-ttu-id="511dc-704">Es posible que la función de guardar archivos existentes no funcione.</span><span class="sxs-lookup"><span data-stu-id="511dc-704">Saving existing files may not work.</span></span>
- <span data-ttu-id="511dc-705">El uso de las teclas de flecha en la ventana del editor de ortografía y gramática puede provocar parpadeos intermitentes.</span><span class="sxs-lookup"><span data-stu-id="511dc-705">Using arrow keys in the Spelling and Grammar editor window may result in intermittent flickering.</span></span>
- <span data-ttu-id="511dc-706">Al resolver un seguimiento, es posible que los comentarios asociados no se conviertan en comentarios puntuales.</span><span class="sxs-lookup"><span data-stu-id="511dc-706">When resolving a follow-up, associated comments may not convert to point comments.</span></span>
- <span data-ttu-id="511dc-707">Al insertar un modelo 3D (animado o estático) e intentar el "Guardar como imagen" no funciona.</span><span class="sxs-lookup"><span data-stu-id="511dc-707">Inserting a 3D model (animated or static) and trying to 'Save as Picture' doesn't work.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-708">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-708">Office Suite</span></span>
- <span data-ttu-id="511dc-709">Se ha solucionado un problema por el que los mensajes de actualización de Office aparecían en un idioma diferente al esperado.</span><span class="sxs-lookup"><span data-stu-id="511dc-709">Fixed an issue where Office update messages appear in a different language than expected.</span></span> <span data-ttu-id="511dc-710">En el futuro, los mensajes de actualización de Office coincidirán correctamente con el idioma de visualización de Windows.</span><span class="sxs-lookup"><span data-stu-id="511dc-710">Going forward, Office update messages will correctly match the Windows display language.</span></span>
 
[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)
 
## <a name="version-1912-december-06"></a><span data-ttu-id="511dc-712">Versión 1912: 6 de diciembre </span><span class="sxs-lookup"><span data-stu-id="511dc-712">Version 1912: December 06</span></span>
<span data-ttu-id="511dc-713">*Versión 1912 (compilación 12325.20012)*</span><span class="sxs-lookup"><span data-stu-id="511dc-713">*Version 1912 (Build 12325.20012)*</span></span>
 
[//]: # (NO QUITAR OPCIONES DETALLES CONTENIDO INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-715">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-715">Feature updates</span></span>
### <a name="outlook"></a><span data-ttu-id="511dc-716">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-716">Outlook</span></span>
 
- <span data-ttu-id="511dc-717">**Configuración avanzada del correo electrónico del grupo:** Esta característica ayuda a los usuarios del grupo a personalizar qué mensajes o eventos recibirán o seguirán en la bandeja de entrada.</span><span class="sxs-lookup"><span data-stu-id="511dc-717">**Advanced group email settings:** This feature helps groups users to customize which emails or events to receive/follow in their inbox.</span></span>
 
- <span data-ttu-id="511dc-718">**Directiva de nomenclatura de grupos:** las directivas de nomenclatura de grupo permiten al administrador de TI normalizar y administrar los nombres de los grupos creados por usuarios de la organización.</span><span class="sxs-lookup"><span data-stu-id="511dc-718">**Groups Naming policy:** A group naming policy enables the IT admin to standardize and manage the names of groups created by users in the organization.</span></span> <span data-ttu-id="511dc-719">El administrador puede requerir que se añada un prefijo o sufijo concreto al nombre de un grupo cuando se crea y puede bloquear el uso de determinadas palabras.</span><span class="sxs-lookup"><span data-stu-id="511dc-719">The admin can require a specific prefix and suffix be added to the name for a group when it's created, and can block specific words from being used.</span></span> <span data-ttu-id="511dc-720">Esto ayuda a minimizar el uso de palabras inadecuadas en los nombres de grupo, y permite que el administrador de TI gestione la representación de los grupos en el directorio.</span><span class="sxs-lookup"><span data-stu-id="511dc-720">This helps minimize the use of inappropriate words in group names as well as IT manage the representation of groups in their directory.</span></span> <span data-ttu-id="511dc-721">La Directiva de nomenclatura también ayuda a las organizaciones que implementan sitios de grupo a organizarse en base al departamento.</span><span class="sxs-lookup"><span data-stu-id="511dc-721">Naming Policy also helps organizations that deploy team sites to categorize them based on department.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-722">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-722">Office Suite</span></span>
 
- <span data-ttu-id="511dc-723">**Paneles con pestañas:** ahora puede cambiar entre varios paneles con la pestaña situada en la parte derecha de la aplicación.</span><span class="sxs-lookup"><span data-stu-id="511dc-723">**Tabbed Panes:** Now you can switch between multiple panes using a tab UI on the right hand side of the app.</span></span> <span data-ttu-id="511dc-724">Esta interfaz de usuario solo será visible cuando haya dos o más paneles abiertos.</span><span class="sxs-lookup"><span data-stu-id="511dc-724">The UI will only be visible when you have 2+ panes open.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-727">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-727">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-728">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-728">Excel</span></span>
- <span data-ttu-id="511dc-729">Es posible que los usuarios vean un error cuando guarden cambios si usan grupos de caracteres que no están en inglés.</span><span class="sxs-lookup"><span data-stu-id="511dc-729">Users may encounter an error when saving changes while using some non-English character sets.</span></span>
- <span data-ttu-id="511dc-730">Es posible que los usuarios vean un error si acceden a un rango con nombre oculto.</span><span class="sxs-lookup"><span data-stu-id="511dc-730">Users may encounter an error when accessing a hidden named range.</span></span>
- <span data-ttu-id="511dc-731">Deshabilitar la aceleración de gráficos de hardware con resolución 4K puede causar que se retrase el renderizado de celdas al desplazarse por ellas.</span><span class="sxs-lookup"><span data-stu-id="511dc-731">Disabling hardware graphics acceleration with 4K resolution may result in delayed rendering of cells when scrolling around.</span></span>
- <span data-ttu-id="511dc-732">También es posible que se vean los bordes de una celda cuando borre fórmulas que, por su longitud, sobrepasen el límite de la celda.</span><span class="sxs-lookup"><span data-stu-id="511dc-732">Clearing a long formula that overlaps a cell boundary may still display across the cell boundary.</span></span>
- <span data-ttu-id="511dc-733">Se ha resuelto un problema en el que no se cargaba la personalización de cinta de opciones al abrir un libro insertado.</span><span class="sxs-lookup"><span data-stu-id="511dc-733">Resolved an issue with ribbon customization not loading when opening embedded workbook.</span></span>
- <span data-ttu-id="511dc-734">Es posible que el menú desplegable de Margen no se muestre correctamente.</span><span class="sxs-lookup"><span data-stu-id="511dc-734">Margin dropdown menu may not render correctly.</span></span>
 
### <a name="onenote"></a><span data-ttu-id="511dc-735">OneNote</span><span class="sxs-lookup"><span data-stu-id="511dc-735">OneNote</span></span>
- <span data-ttu-id="511dc-736">Es posible que OneNote no se abra con el complemento de Outlook "Notas de la reunión".</span><span class="sxs-lookup"><span data-stu-id="511dc-736">OneNote may not open via the 'Meeting Notes' Outlook add-in.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="511dc-737">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-737">Outlook</span></span>
- <span data-ttu-id="511dc-738">Las etiquetas de directivas de retención pueden mostrar el período de tiempo de retención entre paréntesis.</span><span class="sxs-lookup"><span data-stu-id="511dc-738">Retention policy labels may display the retention time period in parenthesis.</span></span>
- <span data-ttu-id="511dc-739">Es posible que aparezcan espacios en blanco en las Tarjetas de contacto con el paquete de idioma japonés.</span><span class="sxs-lookup"><span data-stu-id="511dc-739">Blank spaces may appear in Contact cards with Japanese language pack.</span></span>
- <span data-ttu-id="511dc-740">En ocasiones, las imágenes insertadas en mensajes de correo electrónico de Outlook pueden cambiar de tamaño.</span><span class="sxs-lookup"><span data-stu-id="511dc-740">Images inserted inline to Outlook e-mail messages can sometimes get resized.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-741">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-741">PowerPoint</span></span>
- <span data-ttu-id="511dc-742">Si un usuario tiene dos o más vídeos diferentes en una diapositiva en un archivo de la nube, las imágenes de vídeo se procesan correctamente, pero cuando el usuario hace clic en cada una de ellas para reproducirlas, el contenido de vídeo es siempre el mismo.</span><span class="sxs-lookup"><span data-stu-id="511dc-742">If a user has two (or more) different videos on a slide in a cloud file, the video images are rendered correctly, but when the user clicks on each one to play, the video content is the same.</span></span>
- <span data-ttu-id="511dc-743">En algunos casos, no funciona el desplazamiento con los dispositivos táctiles.</span><span class="sxs-lookup"><span data-stu-id="511dc-743">In some cases, scrolling with touch devices will not work.</span></span>
- <span data-ttu-id="511dc-744">El margen del menú desplegable puede no renderizarse correctamente.</span><span class="sxs-lookup"><span data-stu-id="511dc-744">Margin dropdown menu may not render correctly.</span></span>
- <span data-ttu-id="511dc-745">Los vínculos seguros de una aplicación de Office a otra pueden no iniciar la aplicación vinculada.</span><span class="sxs-lookup"><span data-stu-id="511dc-745">Safelinks from one Office application to another may not launch the linked application.</span></span>
 
### <a name="project"></a><span data-ttu-id="511dc-746">Project</span><span class="sxs-lookup"><span data-stu-id="511dc-746">Project</span></span>
- <span data-ttu-id="511dc-747">Project puede bloquearse cuando se usa la función Comparar proyectos.</span><span class="sxs-lookup"><span data-stu-id="511dc-747">Project may crash when you use the Compare Projects feature.</span></span>
- <span data-ttu-id="511dc-748">Si se encuentra en el Modo oscuro, al ir al panel del inspector de tareas en una tarea con un exceso de asignación de recursos, no podrá leer la tabla.</span><span class="sxs-lookup"><span data-stu-id="511dc-748">If you are in Dark mode, when you go to the task inspector panel on a task with an over allocated resource, you are unable to read the table.</span></span>
- <span data-ttu-id="511dc-749">Establecer el esfuerzo para las tareas que no tienen asignaciones se redondea a 1 día.</span><span class="sxs-lookup"><span data-stu-id="511dc-749">Setting effort on tasks that have no assignments are rounded to 1 day.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-750">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-750">Word</span></span>
- <span data-ttu-id="511dc-751">Guardar un archivo después de una combinación de correspondencia puede no funcionar en determinadas condiciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-751">Saving a file after doing a mail merge may not work under certain conditions.</span></span>
- <span data-ttu-id="511dc-752">Es posible que el Organizador de bloques de creación muestre una alerta no válida: &quot;Modificó estilos, bloques de creación&quot;.</span><span class="sxs-lookup"><span data-stu-id="511dc-752">Building blocks organizer may display an invalid alert: &quot;You have modified styles, building blocks&quot;.</span></span>
- <span data-ttu-id="511dc-753">En ocasiones, el panel de comentarios se carga cuando se usa copiar o pegar.</span><span class="sxs-lookup"><span data-stu-id="511dc-753">Comment pane sometimes gets reloaded when using copy/paste.</span></span>
- <span data-ttu-id="511dc-754">En ocasiones, los comentarios no se pegan en el orden correcto.</span><span class="sxs-lookup"><span data-stu-id="511dc-754">Comments are sometimes not pasted in the correct order.</span></span>
- <span data-ttu-id="511dc-755">Aplicar una plantilla que consista en una lista multinivel con estilos personalizados para los documentos existentes quizás no mantenga el estilo en determinadas condiciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-755">Applying a template consisting of a multi-level list with custom styles to existing documents may not preserve the style under certain conditions.</span></span>
- <span data-ttu-id="511dc-756">Cambiar el tamaño del borde de la pantalla dividida puede incluir una pantalla dividida adicional.</span><span class="sxs-lookup"><span data-stu-id="511dc-756">Resizing a split screen border may introduce an additional split screen.</span></span>
- <span data-ttu-id="511dc-757">Es posible que el menú desplegable de Margen no se muestre correctamente.</span><span class="sxs-lookup"><span data-stu-id="511dc-757">Margin dropdown menu may not render correctly.</span></span>
- <span data-ttu-id="511dc-758">Es posible que al mencionar a un usuario en una tarjeta de comentario se muestre un JSON.</span><span class="sxs-lookup"><span data-stu-id="511dc-758">At-mentioning a user in a comment card may show JSON.</span></span>
- <span data-ttu-id="511dc-759">Los vínculos seguros de una aplicación de Office a otra pueden no iniciar la aplicación vinculada.</span><span class="sxs-lookup"><span data-stu-id="511dc-759">Safelinks from one Office application to another may not launch the linked application.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-760">Conjunto de programas de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-760">Office Suite</span></span>
- <span data-ttu-id="511dc-761">Para los productos basados en japonés, el nombre y apellidos del usuario de la cuenta pueden aparecer en el orden incorrecto.</span><span class="sxs-lookup"><span data-stu-id="511dc-761">For Japanese based products, account user first name, last name may appear in incorrect order.</span></span>
- <span data-ttu-id="511dc-762">Al colocar el puntero del ratón sobre los comentarios, se puede mostrar un contorno de cuadro de texto alrededor del comentario.</span><span class="sxs-lookup"><span data-stu-id="511dc-762">Hovering a mouse pointer over comments may display a textbox outline around the comment.</span></span>
 
[//]: # (NO QUITAR DETALLES DEL ERROR CONTENIDO FINAL)
 
## <a name="version-1912-november-15"></a><span data-ttu-id="511dc-764">Versión 1912: 15 de noviembre</span><span class="sxs-lookup"><span data-stu-id="511dc-764">Version 1912: November 15</span></span>
<span data-ttu-id="511dc-765">*Versión 1912 (compilación 12307.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-765">*Version 1912 (Build 12307.20000)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-767">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-767">Feature updates</span></span>
### <a name="insights-services"></a><span data-ttu-id="511dc-768">Servicios de información</span><span class="sxs-lookup"><span data-stu-id="511dc-768">Insights Services</span></span>
- <span data-ttu-id="511dc-769">**Consultas en lenguaje natural en Ideas en Excel:** la nueva capacidad de ideas de Excel para hacer una pregunta en lenguaje natural sobre sus datos.</span><span class="sxs-lookup"><span data-stu-id="511dc-769">**Natural Language Queries in Ideas in Excel:** Excel Ideas's new capability to ask a natural language question about your data.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-772">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-772">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-773">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-773">Excel</span></span>
- <span data-ttu-id="511dc-774">La funcionalidad de texto a columna puede fallar en algunas localizaciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-774">Text to Column functionality may fail for some localizations.</span></span>
- <span data-ttu-id="511dc-775">Editar fórmulas de matrices dinámicas dentro de una celda puede resultar en que el texto se alinee fuera del límite de la celda.</span><span class="sxs-lookup"><span data-stu-id="511dc-775">Editing dynamic array formulas within a cell may result in text being aligned outside of the boundary of the cell.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="511dc-776">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-776">Outlook</span></span>
- <span data-ttu-id="511dc-777">Añadida la posibilidad de aplicar la configuración S/MIME a través de la directiva de grupo.</span><span class="sxs-lookup"><span data-stu-id="511dc-777">Added the ability to enforce S/MIME configuration via group policy.</span></span>
- <span data-ttu-id="511dc-778">Las imágenes incrustadas pueden parecer más pequeñas de lo esperado.</span><span class="sxs-lookup"><span data-stu-id="511dc-778">Embedded images may appear smaller than expected.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-779">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-779">PowerPoint</span></span>
- <span data-ttu-id="511dc-780">El cursor puede desaparecer después de mover el foco del texto.</span><span class="sxs-lookup"><span data-stu-id="511dc-780">Cursor may disappear after moving focus from text.</span></span>
 
### <a name="project"></a><span data-ttu-id="511dc-781">Project</span><span class="sxs-lookup"><span data-stu-id="511dc-781">Project</span></span>
- <span data-ttu-id="511dc-782">Los usuarios pueden experimentar un error con respecto a la licencia.</span><span class="sxs-lookup"><span data-stu-id="511dc-782">Users may experience an error regarding licensing.</span></span>
- <span data-ttu-id="511dc-783">El botón Hoy en el selector de fecha a veces puede establecer una fecha incorrecta.</span><span class="sxs-lookup"><span data-stu-id="511dc-783">The Today button in the date picker may sometimes set the incorrect date.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-784">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-784">Word</span></span>
- <span data-ttu-id="511dc-785">A veces al hacer clic con el botón derecho del ratón no se puede seleccionar la palabra completa.</span><span class="sxs-lookup"><span data-stu-id="511dc-785">Right-clicking can sometimes not result in selecting the whole word.</span></span>
- <span data-ttu-id="511dc-786">El cursor puede permanecer activo dentro de un objeto después de convertirlo a un formato sugerido.</span><span class="sxs-lookup"><span data-stu-id="511dc-786">The cursor may remain active within an object after converting to a suggested format.</span></span>
- <span data-ttu-id="511dc-787">Las imágenes de los mensajes pueden tener una escala incorrecta en algunos escenarios.</span><span class="sxs-lookup"><span data-stu-id="511dc-787">Images in messages may be incorrectly scaled in some scenarios.</span></span>
- <span data-ttu-id="511dc-788">Algunos temas pueden dificultar la determinación del comentario seleccionado.</span><span class="sxs-lookup"><span data-stu-id="511dc-788">Some themes may make it difficult to determine which comment is selected.</span></span>
- <span data-ttu-id="511dc-789">La selección de una sugerencia de comentario debería mostrar ahora el panel de comentarios modernos cuando esté oculto en el conmutador de paneles.</span><span class="sxs-lookup"><span data-stu-id="511dc-789">Selecting a comment hint should now show the modern comments pane when hidden in pane switcher.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-790">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-790">Office Suite</span></span>
- <span data-ttu-id="511dc-791">Responder a un comentario puede hacer que el cuadro de texto se expanda verticalmente más allá del borde del panel.</span><span class="sxs-lookup"><span data-stu-id="511dc-791">Replying to a comment may cause the textbox to expand vertically beyond the edge of the pane.</span></span>
 
[//]: # (NO ELIMINAR LOS DETALLES DE ERROR DEL CONTENIDO FINAL)
 
## <a name="version-1912-november-08"></a><span data-ttu-id="511dc-793">Versión 1912: 08 de noviembre</span><span class="sxs-lookup"><span data-stu-id="511dc-793">Version 1912: November 08</span></span>
<span data-ttu-id="511dc-794">*Versión 1912 (compilación 12231.20000)*</span><span class="sxs-lookup"><span data-stu-id="511dc-794">*Version 1912 (Build 12231.20000)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-796">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-796">Feature updates</span></span>
### <a name="user-lifecycle"></a><span data-ttu-id="511dc-797">Ciclo de vida del usuario</span><span class="sxs-lookup"><span data-stu-id="511dc-797">User Lifecycle</span></span>
- <span data-ttu-id="511dc-798">**Experimente mejoras para la activación de AFO:** Actualizaciones que los clientes ven en sus pantallas cuando activan el Office que viene con su nueva PC.</span><span class="sxs-lookup"><span data-stu-id="511dc-798">**Experience improvements for AFO activation:** Updates to the screens customers see when activating Office that comes bundled with their new PC.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-799">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-799">Word</span></span>
- <span data-ttu-id="511dc-800">**Nueva y mejorada experiencia de vídeo online en Word:** Nueva y más segura experiencia de vídeo en línea para ayudarle a insertar nuevos vídeos y reproducir vídeos existentes en Word.</span><span class="sxs-lookup"><span data-stu-id="511dc-800">**New and improved online video experience in Word:** New and more secure online video experience to help you insert new videos and play existing videos in Word.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-803">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-803">Resolved issues</span></span>
### <a name="outlook"></a><span data-ttu-id="511dc-804">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-804">Outlook</span></span>
- <span data-ttu-id="511dc-805">Accidente intermitente con contenido de carpetas cruzadas.</span><span class="sxs-lookup"><span data-stu-id="511dc-805">Intermittent crash involving cross folder content.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-806">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-806">Office Suite</span></span>
- <span data-ttu-id="511dc-807">Al pegar un gráfico de Excel a PowerPoint este puede reducir su tamaño.</span><span class="sxs-lookup"><span data-stu-id="511dc-807">Pasting a chart from Excel to PowerPoint can reduce the size of the chart.</span></span>
 
[//]: # (NO QUITAR DETALLES DE ERROR DEL CONTENIDO FINAL)
 
## <a name="version-1911-november-01"></a><span data-ttu-id="511dc-809">Versión 1911: 01 de noviembre</span><span class="sxs-lookup"><span data-stu-id="511dc-809">Version 1911: November 01</span></span>
<span data-ttu-id="511dc-810">*Versión 1911 (compilación 12228.20020)*</span><span class="sxs-lookup"><span data-stu-id="511dc-810">*Version 1911 (Build 12228.20020)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-812">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-812">Feature updates</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-813">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-813">Excel</span></span>
- <span data-ttu-id="511dc-814">**¡Traiga el contexto junto con sus objetos SVG!:** ahora puede conservar el texto en mapas, gráficos y otros vectores SVG al convertir estos objetos en Office.</span><span class="sxs-lookup"><span data-stu-id="511dc-814">**Bring the context along with your SVG objects!:** Now you can retain the text in maps, chart and other SVG vectors when converting these objects in Office.</span></span>
 
- <span data-ttu-id="511dc-815">**Vea las opciones de pluma al seleccionar el Lápiz para Surface**: cuando elija el Lápiz de Surface por primera vez en Word, Excel o PowerPoint, la pestaña Dibujar se activará para que sea fácil seleccionar los colores de pluma.</span><span class="sxs-lookup"><span data-stu-id="511dc-815">**See Your Pen Options When You Pick Up Your Surface Pen:** When you first pick up your Surface Pen in Word, Excel, or PowerPoint, the Draw tab will be activated to make selecting your pen colors easy.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-816">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-816">PowerPoint</span></span>
- <span data-ttu-id="511dc-817">**¡Traiga el contexto junto con sus objetos SVG!:** ahora puede conservar el texto en mapas, gráficos y otros vectores SVG al convertir estos objetos en Office.</span><span class="sxs-lookup"><span data-stu-id="511dc-817">**Bring the context along with your SVG objects!:** Now you can retain the text in maps, chart and other SVG vectors when converting these objects in Office.</span></span>
 
- <span data-ttu-id="511dc-818">**Vea las opciones de pluma al seleccionar el Lápiz para Surface**: cuando elija el Lápiz de Surface por primera vez en Word, Excel o PowerPoint, la pestaña Dibujar se activará para que sea fácil seleccionar los colores de pluma.</span><span class="sxs-lookup"><span data-stu-id="511dc-818">**See Your Pen Options When You Pick Up Your Surface Pen:** When you first pick up your Surface Pen in Word, Excel, or PowerPoint, the Draw tab will be activated to make selecting your pen colors easy.</span></span>
 
### <a name="visio"></a><span data-ttu-id="511dc-819">Visio</span><span class="sxs-lookup"><span data-stu-id="511dc-819">Visio</span></span>
- <span data-ttu-id="511dc-820">\*\* Haga diagramas de Visio pulidos en Excel:\*\* Visualice rápida y fácilmente sus datos en diagramas Visio pulidos dentro de Excel.</span><span class="sxs-lookup"><span data-stu-id="511dc-820">**Make polished Visio diagrams in Excel:** Quickly and easily visualize your data into polished Visio diagrams within Excel.</span></span> <span data-ttu-id="511dc-821">[Más información](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c).</span><span class="sxs-lookup"><span data-stu-id="511dc-821">[Learn more](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c).</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-822">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-822">Word</span></span>
- <span data-ttu-id="511dc-823">**Vea las opciones de pluma al seleccionar el Lápiz para Surface**: cuando elija el Lápiz de Surface por primera vez en Word, Excel o PowerPoint, la pestaña Dibujar se activará para que sea fácil seleccionar los colores de pluma.</span><span class="sxs-lookup"><span data-stu-id="511dc-823">**See Your Pen Options When You Pick Up Your Surface Pen:** When you first pick up your Surface Pen in Word, Excel, or PowerPoint, the Draw tab will be activated to make selecting your pen colors easy.</span></span>
 
- <span data-ttu-id="511dc-824">**Mejoras en la coautoría:** Mejoró la experiencia de coautoría al hacer más probable que los cambios de contenido sean recibidos por otros en tiempo real.</span><span class="sxs-lookup"><span data-stu-id="511dc-824">**Coauthoring improvements:** Improved the coauthoring experience by making it more likely that content changes will be received by others in real time.</span></span>
 
- <span data-ttu-id="511dc-825">**Otros usuarios verán los cambios rápidamente**: con las mejoras en la coautoría, los colaboradores podrán ver los cambios más rápido que nunca.</span><span class="sxs-lookup"><span data-stu-id="511dc-825">**Others see your changes quickly:** Co-authoring improvements mean your collaborators can see your changes faster than ever before.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-828">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-828">Resolved issues</span></span>
### <a name="excel"></a><span data-ttu-id="511dc-829">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-829">Excel</span></span>
- <span data-ttu-id="511dc-830">Resuelto un problema por el que Excel podía fallar al editar un archivo protegido desde una red compartida no fiable.</span><span class="sxs-lookup"><span data-stu-id="511dc-830">Resolved an issue where Excel may crash when editing a protected file from an untrusted network share.</span></span>
- <span data-ttu-id="511dc-831">Se ha resuelto un problema por el que, al eliminar hojas que contenían minigráficos que hacían referencia a datos en otra hoja, podía provocar que el archivo se identificara como dañado al volver a abrirlo.</span><span class="sxs-lookup"><span data-stu-id="511dc-831">Resolved an issue where deleting sheets containing sparklines referencing data on another sheet could cause the file to be identified as corrupted when re-opened.</span></span>
- <span data-ttu-id="511dc-832">Se ha resuelto un problema por el que se podían obtener resultados incorrectos al convertir los filtros de un informe junto con el resto de la tabla dinámica de consultas enviadas a servidores tabulares SQL.</span><span class="sxs-lookup"><span data-stu-id="511dc-832">Resolved an Issue where you may get incorrect results when converting report filters along with the rest of the PivotTable for queries to SQL tabular servers.</span></span>
- <span data-ttu-id="511dc-833">El uso simultáneo del Narrador y la Lupa puede provocar un accidente.</span><span class="sxs-lookup"><span data-stu-id="511dc-833">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
- <span data-ttu-id="511dc-834">El uso simultáneo del Narrador y la Lupa puede provocar un accidente.</span><span class="sxs-lookup"><span data-stu-id="511dc-834">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
 
### <a name="outlook"></a><span data-ttu-id="511dc-835">Outlook</span><span class="sxs-lookup"><span data-stu-id="511dc-835">Outlook</span></span>
- <span data-ttu-id="511dc-836">Pueden faltar imágenes insertadas en un mensaje de correo electrónico reenviado.</span><span class="sxs-lookup"><span data-stu-id="511dc-836">A forwarded e-mail may be missing embedded images.</span></span>
- <span data-ttu-id="511dc-837">La herramienta Buscador de salas puede estar mostrando &quot;Ninguno&quot; en salones disponibles.</span><span class="sxs-lookup"><span data-stu-id="511dc-837">Room Finder tool may be displaying &quot;None&quot; for available rooms.</span></span>
- <span data-ttu-id="511dc-838">Es posible que los usuarios no puedan crear perfiles de Outlook con restricciones estrictas para los inquilinos.</span><span class="sxs-lookup"><span data-stu-id="511dc-838">Users may not be able to create Outlook profiles with strict tenant restriction.</span></span>
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-839">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-839">PowerPoint</span></span>
- <span data-ttu-id="511dc-840">El uso simultáneo del Narrador y la Lupa puede provocar un accidente.</span><span class="sxs-lookup"><span data-stu-id="511dc-840">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
 
### <a name="project"></a><span data-ttu-id="511dc-841">Project</span><span class="sxs-lookup"><span data-stu-id="511dc-841">Project</span></span>
- <span data-ttu-id="511dc-842">El usuario no puede marcar una tarea como completada, y esta se establece en un 99 %.</span><span class="sxs-lookup"><span data-stu-id="511dc-842">User is unable to mark a task as complete, and it gets set to 99%.</span></span>
- <span data-ttu-id="511dc-843">Redistribuir no resuelve las sobreasignaciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-843">Overallocations are not resolved by leveling.</span></span>
 
### <a name="word"></a><span data-ttu-id="511dc-844">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-844">Word</span></span>
- <span data-ttu-id="511dc-845">El uso simultáneo del Narrador y la Lupa puede provocar un accidente.</span><span class="sxs-lookup"><span data-stu-id="511dc-845">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
- <span data-ttu-id="511dc-846">Abrir documentos heredados y luego ir a la pestaña Información puede causar un bloqueo.</span><span class="sxs-lookup"><span data-stu-id="511dc-846">Opening legacy documents and then going to the Info tab can cause a crash.</span></span>
- <span data-ttu-id="511dc-847">Las sugerencias de prueba no se muestran en los menús contextuales.</span><span class="sxs-lookup"><span data-stu-id="511dc-847">Proofing suggestins are not displaying in contextual menus.</span></span>
- <span data-ttu-id="511dc-848">Las políticas de contenido se están aplicando incorrectamente a los comentarios.</span><span class="sxs-lookup"><span data-stu-id="511dc-848">Content policies are being incorrectly applied to comments.</span></span>
- <span data-ttu-id="511dc-849">Los comentarios anteriores escritos con texto oscuro no son visibles en el Modo oscuro.</span><span class="sxs-lookup"><span data-stu-id="511dc-849">Legacy comments written with dark text is not visible in Dark Mode.</span></span>
- <span data-ttu-id="511dc-850">Es posible que aparezcan caracteres incorrectos al utilizar la función de autocorrección en coreano/inglés.</span><span class="sxs-lookup"><span data-stu-id="511dc-850">Incorrect characters may appear when using Korean/English autocorrect.</span></span>
- <span data-ttu-id="511dc-851">Las etiquetas de política más bajas pueden aplicarse cuando una etiqueta de política más alta debería haber tenido prioridad.</span><span class="sxs-lookup"><span data-stu-id="511dc-851">Lower policy labels may be applied when a higher policy label should have taken priority.</span></span>
- <span data-ttu-id="511dc-852">Los enlaces de cid: imágenes de los mensajes de Outlook&nbsp;ahora puede romperse con éxito cuando se solicite.</span><span class="sxs-lookup"><span data-stu-id="511dc-852">The links of cid: images from Outlook messages&nbsp;can now be successfully broken when requested.</span></span>
- <span data-ttu-id="511dc-853">El uso simultáneo del Narrador y la Lupa puede provocar un accidente.</span><span class="sxs-lookup"><span data-stu-id="511dc-853">Using Narrator and Magnifier at the same time may result in a crash.</span></span>
- <span data-ttu-id="511dc-854">La búsqueda desde el panel de navegación puede fallar.</span><span class="sxs-lookup"><span data-stu-id="511dc-854">Searching from the Navigation pane may fail.</span></span>
 
### <a name="office-suite"></a><span data-ttu-id="511dc-855">Conjunto de aplicaciones de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-855">Office Suite</span></span>
- <span data-ttu-id="511dc-856">Puede que algunos dibujos no se muestren en la vista previa o en las presentaciones.</span><span class="sxs-lookup"><span data-stu-id="511dc-856">Some drawings may not display in preview or slide shows.</span></span>
- <span data-ttu-id="511dc-857">Algunos caracteres de katakana pueden aparecer incorrectamente en un cuadro de texto vertical.</span><span class="sxs-lookup"><span data-stu-id="511dc-857">Some katakana characters may display incorrectly in a vertical text box.</span></span>
- <span data-ttu-id="511dc-858">Si se intenta guardar un archivo en un recurso compartido de red desconectado, es posible que se produzca un error.</span><span class="sxs-lookup"><span data-stu-id="511dc-858">Attempting to save a file to a disconnected network share may result in a crash.</span></span>
 
[//]: # (NO ELIMINAR LOS DETALLES DE ERROR DEL CONTENIDO FINAL)
 
## <a name="version-1911-october-25"></a><span data-ttu-id="511dc-860">Versión 1911: 25 de octubre</span><span class="sxs-lookup"><span data-stu-id="511dc-860">Version 1911: October 25</span></span>
<span data-ttu-id="511dc-861">*Versión 1911 (compilación 12215.20006)*</span><span class="sxs-lookup"><span data-stu-id="511dc-861">*Version 1911 (Build 12215.20006)*</span></span>
 
[//]: # (NO BORRAR LAS CARACTERÍSTICAS DEL CONTENIDO DE INICIO)
 
### <a name="feature-updates"></a><span data-ttu-id="511dc-863">Actualizaciones de características</span><span class="sxs-lookup"><span data-stu-id="511dc-863">Feature updates</span></span>
### <a name="visio"></a><span data-ttu-id="511dc-864">Visio</span><span class="sxs-lookup"><span data-stu-id="511dc-864">Visio</span></span>
 
- <span data-ttu-id="511dc-865">**Haga diagramas de Visio pulidos en Excel:** Visualice rápida y fácilmente sus datos en diagramas Visio pulidos dentro de Excel.</span><span class="sxs-lookup"><span data-stu-id="511dc-865">**Make polished Visio diagrams in Excel:** Quickly and easily visualize your data into polished Visio diagrams within Excel.</span></span> [<span data-ttu-id="511dc-866">Más información</span><span class="sxs-lookup"><span data-stu-id="511dc-866">Learn more</span></span>](https://support.office.com/article/bee3b5aa-aaaf-4401-acc6-276b711c763c)
 
### <a name="word"></a><span data-ttu-id="511dc-867">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-867">Word</span></span>
 
- <span data-ttu-id="511dc-868">**Mejoras en la coautoría:** Mejoró la experiencia de coautoría al hacer más probable que los cambios de contenido sean recibidos por otros en tiempo real.</span><span class="sxs-lookup"><span data-stu-id="511dc-868">**Coauthoring improvements:** Improved the coauthoring experience by making it more likely that content changes will be received by others in real time.</span></span>
 
- <span data-ttu-id="511dc-869">**Otros usuarios verán los cambios rápidamente**: con las mejoras en la coautoría, los colaboradores podrán ver los cambios más rápido que nunca.</span><span class="sxs-lookup"><span data-stu-id="511dc-869">**Others see your changes quickly:** Co-authoring improvements mean your collaborators can see your changes faster than ever before.</span></span>
...
### <a name="resolved-issues"></a><span data-ttu-id="511dc-872">Problemas corregidos</span><span class="sxs-lookup"><span data-stu-id="511dc-872">Resolved issues</span></span>
### <a name="access"></a><span data-ttu-id="511dc-873">Access</span><span class="sxs-lookup"><span data-stu-id="511dc-873">Access</span></span>
 
- <div><span data-ttu-id="511dc-874"><span>El número de registros podría ser incorrecto</span></span><span class="sxs-lookup"><span data-stu-id="511dc-874"><span>The record count could be incorrect</span></span></span></div>
 
 
### <a name="excel"></a><span data-ttu-id="511dc-875">Excel</span><span class="sxs-lookup"><span data-stu-id="511dc-875">Excel</span></span>
 
- <div><span data-ttu-id="511dc-876"><span>Rendimiento significativamente superior al eliminar columnas con celdas combinadas</span></span><span class="sxs-lookup"><span data-stu-id="511dc-876"><span>We significantly improved the performance of deleting columns with merged cells</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-877"><span>Se podría impedir que los usuarios guarden en formato de la hoja de trabajo de Office 365 Excel</span></span><span class="sxs-lookup"><span data-stu-id="511dc-877"><span>Users could be prevented from saving in Office 365 Excel Workbook format</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-878"><span>Las casillas de verificación no se pueden renderizar correctamente</span></span><span class="sxs-lookup"><span data-stu-id="511dc-878"><span>Checkboxes could not render correctly</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-879"><span>Los cambios en el tamaño del gráfico no se han podido guardar</span></span><span class="sxs-lookup"><span data-stu-id="511dc-879"><span>Changes to a chart size could not be saved</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-880"><span>Algunas funciones VBA devolverían un error en los nuevos tipos de gráficos</span></span><span class="sxs-lookup"><span data-stu-id="511dc-880"><span>Some VBA functions would return an error on new chart types</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-881"><span>Los cuadros de diálogo de selección de fuentes de datos no distinguen entre mayúsculas y minúsculas en algunos campos. </span></span><span class="sxs-lookup"><span data-stu-id="511dc-881"><span>Select Data Source dialogs were not case sensitive for some fields</span></span></span></div>
 
 
### <a name="powerpoint"></a><span data-ttu-id="511dc-882">PowerPoint</span><span class="sxs-lookup"><span data-stu-id="511dc-882">PowerPoint</span></span>
 
- <div><span data-ttu-id="511dc-883"><span>Los cambios en el tamaño del gráfico no se han podido guardar</span></span><span class="sxs-lookup"><span data-stu-id="511dc-883"><span>Changes to a chart size could not be saved</span></span></span></div>
 
 
### <a name="publisher"></a><span data-ttu-id="511dc-884">Publisher</span><span class="sxs-lookup"><span data-stu-id="511dc-884">Publisher</span></span>
 
- <div><span data-ttu-id="511dc-885"><span>Las formas pueden aparecer fuera del borde del gráfico</span></span><span class="sxs-lookup"><span data-stu-id="511dc-885"><span>Shapes could appear outside of the graphics border</span></span></span></div>
 
 
### <a name="word"></a><span data-ttu-id="511dc-886">Word</span><span class="sxs-lookup"><span data-stu-id="511dc-886">Word</span></span>
 
- <div><span data-ttu-id="511dc-887"><span>Las formas pueden aparecer fuera del borde del gráfico</span></span><span class="sxs-lookup"><span data-stu-id="511dc-887"><span>Shapes could appear outside of the graphics border</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-888"><span>Resaltar el texto podría ser un reto</span></span><span class="sxs-lookup"><span data-stu-id="511dc-888"><span>Highlighting text could be challenging</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-889"><span>Se puede impedir que un usuario navegue a un elemento individual en el editor</span></span><span class="sxs-lookup"><span data-stu-id="511dc-889"><span>A user could be prevented from navigating to an individual item in the editor</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-890"><span>Los errores gramaticales u ortográficos pueden no estar resaltados</span></span><span class="sxs-lookup"><span data-stu-id="511dc-890"><span>Grammar or spelling errors might not be highlighted</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-891"><span>Los cambios en el tamaño del gráfico no se han podido guardar</span></span><span class="sxs-lookup"><span data-stu-id="511dc-891"><span>Changes to a chart size could not be saved</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-892"><span>Se podría evitar que una tarjeta de contacto se abra después de aplicar formato a una mención @</span></span><span class="sxs-lookup"><span data-stu-id="511dc-892"><span>A contact card could be prevented from opening after apply formatting to an @ mention</span></span></span></div>
 
 
- <div><span data-ttu-id="511dc-893"><span>Corregido el problema en el que los usuarios no podían guardar documentos de Word, Excel y PowerPoint.&nbsp;Este problema afecta a los usuarios que crean un nuevo archivo y abren la opción&quot; guardar como dialogo modelo&quot; después de hacer clic en el icono guardar o presionar Ctrl + S. </span></span><span class="sxs-lookup"><span data-stu-id="511dc-893"><span>Resolvedan issue where users may be unable to save Word, Excel, and PowerPoint documents.&nbsp; This issue affects users that create a new file and bring up the &quot;Save as Model Dialog&quot; option after clicking on the Save icon or pressing Ctrl + S.</span></span></span></div>
 
 
### <a name="office-suite"></a><span data-ttu-id="511dc-894">Conjunto de programas de Office</span><span class="sxs-lookup"><span data-stu-id="511dc-894">Office Suite</span></span>
 
- <div><span data-ttu-id="511dc-895"><span>Problema de rendimiento al usar Shapes en Windows 7</span></span><span class="sxs-lookup"><span data-stu-id="511dc-895"><span>Performance issue when using Shapes on Windows 7</span></span></span></div>
