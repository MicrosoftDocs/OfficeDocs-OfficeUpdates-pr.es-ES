...
-   La opción Actualizar ahora está oculta de las \> opciones \> de actualización de cuenta de archivos cuando un objeto com de Office está habilitado para que Configuration Manager administre las actualizaciones de cliente de Office 365.
