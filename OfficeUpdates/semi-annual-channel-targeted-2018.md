...
En estas notas de la versión, se proporciona información sobre características nuevas, actualizaciones de seguridad y actualizaciones no relacionadas con la seguridad que se incluyen en las actualizaciones del Canal semestral (dirigido) para Office 365 ProPlus de 2018.
 
> [!NOTE]
> - A continuación también se proporciona información sobre características nuevas, actualizaciones de seguridad y no relacionadas con la seguridad para Visio Pro para Office 365 y el cliente de escritorio de Project Online.
...
### <a name="outlook-feature-updates"></a>Outlook: actualizaciones de características
 - **Mejoras del Comprobador de accesibilidad:** el Comprobador de accesibilidad ha actualizado la compatibilidad con las normas internacionales y recomendaciones para que los mensajes sean más accesible. [Obtener más información](https://support.office.com/article/a16f6de0-2f39-4a2b-8bd8-5ad801426c7f)
...
- **Advertencias sobre los complementos de Outlook:** ocasionalmente un complemento COM de Outlook puede encontrar problemas que ralenticen los demás componentes de Outlook. Estos problemas podrían deberse a causas de latencia de eventos, como alternar entre carpetas de Outlook, la llegada de correo electrónico nuevo, la apertura de elementos de calendario, etc. Cuando se producen estos problemas, se mostrará una advertencia en la barra de notificaciones de Outlook.
...
- **Nunca se pierda un aviso:** establezca avisos para que aparezcan elementos emergentes en las ventanas mientras está trabajando. En caso contrario, Outlook parpadeará en la barra de tareas para llamar su atención.[Más información](https://support.office.com/article/7a992377-ca93-4ddd-a711-851ef3597925)
...
- **Una nueva forma de administrar sprints:** adopte un enfoque ágil para trabajar con paneles de tareas. Vaya a Administrar Sprints para agregar y quitar sprints a medida que evolucione el proyecto.
...
-   Se ha corregido un problema relacionado con la compatibilidad del protocolo TLS 1.2. (Nota: esta es la misma corrección mencionada en las notas de 10 de abril y se menciona aquí nuevo como parte del paquete acumulativo de septiembre.)
...
- **Mantener sincronizados los diagramas y los orígenes:** al editar un diagrama del Visualizador de datos en Visio, tiene la opción de actualizar los datos de origen de Excel vinculados al contenido más reciente de un diagrama.
...
### <a name="office-suite-non-security-updates"></a>Office Suite: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un error que causaba que la instalación de la actualización tardase mucho tiempo en determinados escenarios. 
-   Se ha corregido un problema por el que fallaban las pruebas SVG
-   Se ha corregido un problema por el que, al implementar actualizaciones con System Center Configuration Manager en un cliente que tenía aplicaciones de Office en ejecución, la actualización no se aplicaba después de reiniciar el dispositivo mientras se ejecutaban las aplicaciones de Office.
...
-   Se ha corregido un problema por el que Imprimir o la Vista previa de impresión solo imprimía o mostraba una parte de la hoja de cálculo, con el contenido truncado a una segmentación en la hoja de cálculo.
...
### <a name="project-non-security-updates"></a>Project: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema por el que al utilizar la lista desplegable de Autofiltro en una columna de fecha se ocultaban todas las tareas del proyecto.
...
-   Se ha corregido un problema por el que los números de página en número romanos en minúsculas se cambiaban incorrectamente a mayúsculas.
...
-   Se ha corregido un problema por el que OneDrive para la Empresa (Groove.exe) consumía el valor de CPU de un núcleo de la CPU (por ejemplo, el 25% en una CPU de 4 núcleos) en el Administrador de tareas durante amplios períodos de tiempo.
...
### <a name="word-non-security-updates"></a>Word: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema por el que Word no se abría en un equipo con Windows 7 que no tenía instalada la [actualización de la experiencia del cliente y la telemetría de diagnóstico](https://support.microsoft.com/help/3080149/update-for-customer-experience-and-diagnostic-telemetry).
-   Se ha corregido un problema por el que no se imprimían las viñetas de listas.
...
### <a name="excel-non-security-updates"></a>Excel: actualizaciones no relacionadas con la seguridad
-   Se ha solucionado un problema que causaba que, si el idioma de edición era japonés, chino o coreano, Excel se bloquease al intentar seleccionar otra fuente en la pestaña Inicio o al realizar ediciones.
...
### <a name="outlook-non-security-updates"></a>Outlook: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema por el que la búsqueda daba el error "No se encontraron coincidencias" cuando el ámbito de la búsqueda era Todos los buzones.
...
### <a name="word-non-security-updates"></a>Word: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema que causaba que Word se bloqueara cuando un usuario intentaba usar Guardar como sobre un documento existente en OneDrive para la Empresa y, seguidamente, cancelaba o intentaba combinar cambios existentes.
-   Se ha corregido un problema que, al filtrar campos de orígenes de datos que contuvieran valores nulos (vacíos), causaba errores al ejecutar el Asistente para combinar correspondencia.
-   Se ha corregido un problema que causaba que Office no pudiera escribir en el disco al guardar un archivo de copia de sincronización, pero Office siguiera subiendo el archivo a OneDrive. Con esta corrección, ahora el usuario ve un mensaje de error y la subida no se realiza.
...
-   Se ha corregido un problema que causaba cambios en los formatos de archivo .box. Esto afectaba la funcionalidad de las versiones antiguas de Office instaladas en el mismo equipo, porque los archivos .box se comparten con todas las versiones de una aplicación de Office en el mismo equipo.
...
-   Se agregó una funcionalidad para impedir que usuarios menores de edad puedan comprar y activar complementos de Office de la Tienda Office.
