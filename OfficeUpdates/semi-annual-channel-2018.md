...
En estas notas de la versión, se proporciona información sobre características nuevas, actualizaciones de seguridad y actualizaciones no relacionadas con la seguridad que se incluyen en las actualizaciones de Canal semianual para Office 365 ProPlus en 2018. 
...
-   [CVE-2018-8312](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8312): uso de la ejecución remota de código de Microsoft Access tras la vulnerabilidad gratuita 

### <a name="access-non-security-updates"></a>Access: actualizaciones no relacionadas con la seguridad
-   Se ha solucionado un problema que causaba que, al abrir una aplicación en tiempo de ejecución de Access (archivo .accde), apareciese el mensaje de error "No se puede reconocer el formato de la base de datos" y que no se abriese la aplicación.
-   Se ha solucionado un problema que causaba que pareciera que se seleccionaba todo el texto al intentar seleccionar texto en un cuadro de texto o en un cuadro combinado, en lugar de mostrarse la selección real.
...
-   Se ha corregido un problema por el que no se podía realizar la impresión rápida de un libro de Excel adjuntado a un correo electrónico de Outlook.
...
-   Se ha solucionado un problema por el que, al realizar mediante programación una llamada a Workbook.Open(), Excel podía bloquearse.
...
-   Se ha solucionado un problema que causaba que Excel se pudiera bloquear cuando un usuario abría un menú contextual.
-   Se ha corregido un problema que causaba que Excel se bloqueara cuando el usuario hacía clic en Examinar al intentar insertar un objeto en un libro existente.
-   Se ha solucionado un problema que causaba que, al proteger un intervalo con contraseña, el cuadro de diálogo donde escribir la contraseña para desbloquear el rango no se visualizase.
-   Se ha corregido un problema que causaba que un usuario no pudiera cerrar un libro en la Vista protegida cuando el nombre de archivo contenía corchetes.
-   Se ha corregido un problema que causaba que el desplazamiento de la información rápida quedara incorrectamente alineado al arrastrar elementos o rellenarlos arrastrando.
-   Se ha corregido un problema que, al guardar un libro con Archivo \> Guardar como, causaba que los nombres de archivo que contuvieran puntos aparecieran en blanco o truncados en el cuadro de diálogo de guardar.
...
-   **Ordenar el correo electrónico con facilidad:** gracias a sus comentarios, hemos vuelto a incorporar la ordenación encima de la lista de mensajes y el filtro de no leídos para los usuarios que no usan la Bandeja de entrada Prioritarios.
-   **Convertir iconos SVG en formas:** transforme todas las imágenes e iconos SVG en formas de Office para poder cambiar su color, tamaño o textura.
...
-   **Configuración de características de LinkedIn:** vaya a Archivo \> Opciones \> General para controlar si se muestran las características de LinkedIn en las aplicaciones de Office. [Más información](https://support.office.com/article/dc81cc70-4d64-4755-9f1c-b9536e34d381)
-   **Modelos 3D:** use modelos 3D para aumentar el impacto visual y creativo del correo electrónico. Inserte fácilmente un modelo 3D y, a continuación, podrá girarlo 360 grados. [Más información](https://support.office.com/article/ec5feb79-b0af-47f6-a885-151fcc88ac0a)
-   **Tarjeta de perfil:** le muestra los detalles más relevantes sobre personas y grupos, independientemente de si está en el escritorio o en la web, o si usa una aplicación móvil.
...
-   [CVE-2018-0793](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0793): vulnerabilidad de la ejecución remota de código de Microsoft Outlook
...
-   [CVE-2018-8310](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-8310): vulnerabilidad de alteración de Microsoft Office
...
-   Se ha corregido un problema por el que algunos usuarios no recibían características de soporte técnico que había habilitado su administrador de cuenta empresarial.
...
-   Se ha corregido un problema que causaba que, al supervisar elementos con Accessible Event Watcher (AccEvent.exe), Outlook se bloqueaba al cambiar de carpeta.
...
-   **Vista de panel de tareas:** ordene tareas en las tarjetas desde la vista de panel de tareas. Reordene y mueva las tarjetas en las columnas del panel de la misma forma que con los proyectos ágiles.
...
-   **Administrar una tarea en Planner:** vincule una tarea de proyecto a Planner y cree un plan para ella. Divida la tarea en subtareas, agregue un equipo, asigne tareas y administre el trabajo en un panel de tareas.
...
-   Se ha corregido un problema por el que "Forma del punto de progreso" se dibujaba en una ubicación inesperada.
-   Se ha corregido un problema por el que se perdía código VBA de los proyectos.
-   Se ha corregido un problema que causaba que las tareas se mostraran como completadas, aunque quedase trabajo restante.
-   Se ha corregido un problema que causaba que Project se bloquease al usar la característica de ruta de acceso a la tarea.
-   Se ha corregido un problema que causaba que la escala temporal no mostrase las etiquetas de la escala temporal.
...
-   Se ha corregido un problema por el que un error al guardar podía dañar un archivo y hacer que Project se bloqueara al abrirlo.
-   Se ha corregido un problema que causaba que no pudieran arrastrar tareas en la vista Escala de tiempo ni en la vista Organizador de equipo.
-   Se ha corregido un problema que causaba que la disponibilidad de los recursos no se mostrara en el generador de equipos.
-   Se ha corregido un problema que causaba que los indicadores gráficos no se mostraran correctamente.
-   Se ha corregido un problema que causaba que Project dejara de responder al realizar distribuciones por horas o días.
...
-   Se ha corregido un problema que causaba que, al agregar una asignación a una tarea de duración fija, muchas veces el recurso quedara sin nombre.
-   Se ha corregido un problema que generaba un mensaje de error incorrecto de un cambio en un elemento de trabajo protegido.
-   Se ha corregido un problema por el que Project se podría bloquear al ir a un informe que contenía varias imágenes.
...
-   Se ha corregido un problema que, al filtrar campos de orígenes de datos que contuvieran valores nulos (vacíos), causaba errores al ejecutar el Asistente para combinar correspondencia.
...
-   Se ha corregido un problema que causaba que se rellenara la ubicación, incluso cuando el valor de UseLocationForE911Only era true.
-   Se ha corregido un problema por el que Skype Empresarial dejaba de responder al usar la opción “Llamar con el centro de conferencia” para invitar a usuarios de la lista.
-   Se ha corregido un problema por el que, al ejecutar Outlook en Terminal Server, el programa se bloqueaba al crear una reunión de Skype for Business.
-   Se cambia el valor predeterminado de EnableRestoreOAuthUsedKeyWhenUsingCachedWebTicket a TRUE.
-   Se ha corregido un problema por el que los botones "Más opciones" e "Invitar a más personas" se ocultaban cuando una reunión estaba en modo de pantalla completa.
...
-   Se ha corregido un problema por el que el usuario recibía el mensaje de error "No hemos podido encontrar esta reunión de Skype" al hacer clic en el vínculo "Unirse a la reunión de Skype" en una convocatoria de reunión de Outlook.
...
-   Se ha corrigido un problema por el que, al buscar mensajes en pChat por fecha, se produce un error cuando el formato de fecha es distinto del estadounidense (mm/dd/aa).
-   Se ha corregido un problema por el que, al establecer la directiva EnableExternalP2PFileTransfer en false, los usuarios aún pueden adjuntar archivos a las reuniones.
-   Se ha corregido un problema que causaba que en el historial de conversación se mostrase al autor de la llamada en lugar del receptor de esta. Esto ocurre cuando se modifica el número de trabajo del usuario llamado con Active Directory.
-   Se ha corregido un problema que causaba que para las llamadas RTC salientes a números de teléfono móvil, la información del destinatario faltase en el historial de llamadas del historial de conversaciones.
...
-   Se ha corregido un problema que causaba que el botón "Empezar a usar Teams" se ocultase en el mensaje emergente de redirección de actualización del cliente.
-   Se han corregido problemas de ajustes de escala de PPP en las ventanas de mensajes instantáneos.
-   Se ha corregido un problema que causaba que los datos de LinkedIn no apareciesen en la tarjeta de contacto de Skype for Business.
-   Se ha agregado la capacidad para que los usuarios dejen de recibir llamadas en nombre de un grupo de extensiones.
-   Se ha agregado la capacidad de poner una llamada en espera automáticamente cuando está activa en Skype Empresarial o en Microsoft Teams y se recibe o inicia otra.
-   Se ha corregido un problema que impedía que los usuarios pudiesen usar la mensajería instantánea después de compartir en modo de pantalla completa.
-   Se ha corrgido un problema que impedía que los usuarios recibiesen una notificación cuando se les denegaba el acceso a una reunión.
-   Se ha corregido un problema que causaba que el control automático de ganancia aumentase de forma incontrolada durante las llamadas.
-   Se ha corregido un problema por el que los usuarios no podían seleccionar un moderador en Opciones de reunión cuando se agregaba un buzón de recursos de sala de conferencia a una invitación de reunión.
-   Se ha corregido un problema por el que el botón de escritorio remoto compartido aparece atenuado durante una videollamada punto a punto si AllowlPVideo está establecido en False.
-   Se ha corregido un problema por el que la mensajería instantánea permanecía deshabilitada después de cambiar la configuración de Opción de reunión para Habilitar MI para las reuniones existentes creadas con Deshabilitar MI.
-   Se ha corregido un problema por el que no se mostraba la información sobre herramientas al desplazar el puntero sobre el botón "Insertar vínculo" en la ventana de chat y no había un nombre de accesibilidad al seleccionar el botón.
...
-   [CVE-2018-0793](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0793): vulnerabilidad de la ejecución remota de código de Microsoft Outlook
-   [CVE-2018-0794](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0794): vulnerabilidad de la ejecución remota de código de Microsoft Word
...
-   [CVE-2018-0804](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0804): vulnerabilidad de la ejecución remota de código de Microsoft Word
-   [CVE-2018-0805](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0805): vulnerabilidad de la ejecución remota de código de Microsoft Word
-   [CVE-2018-0806](https://portal.msrc.microsoft.com/en-us/security-guidance/advisory/CVE-2018-0806): vulnerabilidad de la ejecución remota de código de Microsoft Word
...
-   Se ha solucionado un problema relacionado con el zoom y el ajuste de escala en Complementos de Office en el entorno de PPP dinámico.
-   Se ha corregido un problema que causaba que el nodo CurrentStatus del proveedor del servicio de configuración (CSP) de Office devolviera una cadena vacía incluso si Office 365 ProPlus estaba instalado.
-   Se ha corregido un problema que provocaba cambios en los formatos de archivo .box. Esto afectaba a la funcionalidad de versiones antiguas de Office instaladas en el mismo equipo, porque los archivos .box se comparten con todas las versiones de una aplicación de Office en el mismo equipo.
...
-   Se ha corregido un problema por el que fallaban las pruebas SVG
-   Se corrige un problema por el que, al implementar actualizaciones con System Center Configuration Manager en un cliente que tiene aplicaciones de Office en ejecución, la actualización no se aplica después de reiniciar el dispositivo mientras se ejecutan las aplicaciones de Office.
...
### <a name="access-non-security-updates"></a>Access: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema que causaba que, al usar un formulario de varios elementos, al cambiar la posición con la rueda del ratón o con la barra de desplazamiento no se cambiasen los elementos mostrados en el formulario.
...
-   **Editar un nuevo elemento es más accesible:** utilice métodos abreviados de teclado rápido (CTRL+E) para editar un nuevo elemento de un cuadro combinado o cuadro de lista.
...
-   **Insertar imágenes en línea:** nueva página de aterrizaje para la selección de imágenes. Además, la información de atribución se inserta automáticamente con la imagen.
...
-   **Vínculos seguros:** cuando un usuario hace clic en un vínculo, Protección contra amenazas avanzada (ATP) de Office 365 lo inspecciona para comprobar si es malintencionado o no. Si el vínculo se considera malintencionado, se redirige al usuario a una página de advertencia en lugar de redirigirlo a la URL de destino original. [Más información](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)
...
-   **Cambios en archivos compartidos**: vea quién ha realizado cambios en los libros compartidos y restaure versiones anteriores. [Más información](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
-   Se ha corregido un problema por el que la línea de salto de página se colocaba de forma incorrecta en la vista previa de salto de página.
-   Se ha corregido un problema por el que Excel se bloqueaba al abrir un archivo .XLL.
-   Se ha corregido  un problema por el que el estilo de trama de una celda no se representaba correctamente después de agregar un encabezado o pie de página en la vista de diseño de página.
-   Se ha corregido  un problema por el que pegar una copia de una tabla dinámica en otro libro podría ocasionar un bloqueo.
-   Se ha corregido  un problema por el que, cuando elige el comando Reemplazar y se abre el cuadro de diálogo Buscar y reemplazar, el foco del cuadro de diálogo se encuentra en la ficha Buscar, en lugar de la ficha Reemplazar.
-   Se ha corregido  un problema por el que Excel se bloquea al abrir el panel Actividad de un libro abierto desde un servidor de SharePoint anterior a SharePoint Server 2016.
-   Se ha corregido  un problema por el que Excel se abre y muestra una ventana en blanco cuando están habilitados uno o más complementos XLL.
-   Se ha corregido  un problema por el que Excel se bloquea después de haber utilizado el botón Formularios en un libro ya cerrado.
-   Se ha corregido  un problema por el que, cuando se utiliza el evento SheetBeforeRightClick, la inserción de una columna que forma una intersección con celdas combinadas no expande las celdas combinadas.
-   Se ha corregido  un problema por el que Excel se bloqueaba temporalmente al expandir o contraer una tabla dinámica. Además, los encabezados de las tablas dinámicas se mostraban fuera de la pantalla.
-   Se ha corregido  un problema por el que se omitían los caracteres de tabulación al copiar y pegar texto delimitado por tabulaciones desde Word, lo que causaba que el texto no se dividiera en columnas.
-   Se ha corregido  un problema por el que Excel se bloqueaba al abrir el cuadro de diálogo Publicar como página web.
-   Se ha corregido  un problema por el que no se realizaba correctamente una actualización de datos o Excel se bloqueaba al usar datos de un servidor de SQL Server Analysis Services cuando la configuración regional de Excel no era la misma que la del servidor de SQL Server Analysis Services.
...
-   **Clasificaciones empresariales de los grupos:** al crear o editar un grupo, se le puede asignar un nivel de clasificación empresarial definido por el administrador de la cuenta empresarial (por ejemplo, Confidencial). La clasificación en cuestión aparecerá en el encabezado de grupo.
...
-   Se ha corregido  un problema por el que el usuario recibía peticiones de autenticación al interactuar con datos adjuntos.
-   Se ha corregido  un problema por el que el vínculo "Más información" de las sugerencias de directiva no era visible al usar el tema "Gris oscuro".
-   Se ha corregido  un problema por el que Outlook se bloquea cuando un usuario está intentando configurar una nueva cuenta y cierra la ventana sin que haya finalizado la configuración de la cuenta.
-   Se ha corregido  un problema por el que Marcar como leído y Marcar como no leído se muestran como opciones para los mensajes de la Bandeja de entrada compartida de un grupo.
-   Se ha corregido  un problema por el que no se podía configurar una cuenta IMAP en Outlook.
-   Se ha corregido  un problema que provocaba un fallo intermitente al abrir Outlook.
...
-   **Actividad de archivo compartido:** elija el botón Actividad situado en la esquina superior derecha del archivo para ver cuándo se compartió, se editó, se restauró o se renombró un archivo compartido en OneDrive para la Empresa o SharePoint
-   **Creación de texto alternativo:** un servicio basado en la nube genera automáticamente texto alternativo para las imágenes de una presentación.
-   **Vínculos seguros:** cuando un usuario hace clic en un vínculo, Protección contra amenazas avanzada (ATP) de Office 365 lo inspecciona para comprobar si es malintencionado o no. Si el vínculo se considera malintencionado, se redirige al usuario a una página de advertencia en lugar de redirigirlo a la URL de destino original. [Más información](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)
-   **Mejoras para diseñadores:** se recomiendan ideas de diseño profesional para las listas de acción.
-   **Cambios en archivos compartidos:** vea quién ha realizado cambios en las presentaciones compartidas y restaure versiones anteriores. [Más información](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema que provocaba que impedía a Office escribir en el disco al guardar un archivo de copia de sincronización, mientras que continuaba cargando el archivo en OneDrive. Gracias a esta corrección, el usuario ve un mensaje de error y la carga no se realiza.
...
-   Se ha corregido un problema por el que PowerPoint se bloquea al abrir una presentación desde un servidor de SharePoint anterior a SharePoint Server 2016.
-   Se ha corregido  un problema que causaba que no se mostraran los caracteres definidos por el usuario final (EUDC) que están vinculados a  fuentes.
...
-   Se ha corregido  un problema por el que Project se bloqueaba al abrir determinados archivos de Project Online.
-   Se ha corregido  un problema por el que Inicio real podía borrarse por error al establecer trabajo restante.
-   Se ha corregido  un problema por el que, en Fecha de inicio real de la tarea, podían mostrarse datos distintos de los indicados por el recurso en el estado de Project Web App.
-   Se ha corregido  un problema que causaba que el trabajo real volviera a programarse si se cambiaba la fecha de finalización de la tarea.
-   Se ha corregido  un problema que causaba que, al copiar y pegar campos de costos, los valores pegados no coincidieran exactamente con los valores copiados debido a un error de redondeo.
-   Se ha corregido  un problema que causaba que los datos de fase temporal para los recursos de un presupuesto no se copiaran al guardar de una línea base a otra.
-   Se ha corregido  un problema que causaba que el campo de estado no siempre se calculara correctamente para las tareas de resumen.
-   Se ha corregido  un problema que producía que trabajo real se transfiriese de forma errónea a un recurso de empresa al sustituir un recurso local y cuando está habilitado el trabajo protegido.
-   Se ha corregido un problema que producía que Project se bloquease si tenía una tabla en la que la primera columna fuese Nombre de tarea, la columna estuviese bloqueada e hiciese clic en una tarea.
-   Se ha corregido un problema que producía que pudiese asignar el mismo recurso varias veces a la misma tarea mediante la vista Uso de tareas.
-   Se ha corregido  un problema que producía que los valores en los campos personalizados de número se perdiesen al abrir archivos XML.
-   Se ha corregido un problema que producía que la sangría de tareas de nivel superior no se sincronizase correctamente entre Project y la lista de tareas de SharePoint.
-   Se ha corregido  un problema que producía que, al importar información de una asignación, recurso o tarea de un libro de Excel, se ignorasen los valores en el campo de trabajo.
-   Se ha corregido un problema que provocaba que los valores de Línea base de fase temporal no coincidieran con los valores iniciales al guardar un proyecto en el formato de archivo XML.
-   Se ha corregido  un problema que provocaba que el cliente de Project no abriera un proyecto, ya que detectaba que se había extraído del repositorio cuando, realmente, no era así.
-   Se ha corregido  un problema que ralentizaba la apertura de los archivos de Project desde un servidor de archivos con una latencia alta.

### <a name="skype-for-business-security-updates"></a>Skype for Business: actualizaciones de seguridad
...
-   Se ha corregido  un problema por el que los mensajes no leídos en salones de chat persistentes se marcaban como leídos cuando se hace clic en las pestañas de conversación de mensajería instantánea.
-   Se ha corregido un problema en la que las notificaciones de mensajería instantánea entrantes experimentaban un retraso de varios segundos.
-   Se ha corregido un problema por el que un contacto de AD se mostraba como un número de teléfono en lugar del nombre del contacto cuando está deshabilitada la sincronización con Exchange.
-   Se ha corregido  un problema en el que se impedía a los usuarios anónimos unirse cuando estaba deshabilitada la federación y el organizador de la reunión no había bloqueado explícitamente las uniones anónimas.
-   Se ha corregido  un problema en el que se mostraba de manera incorrecta al organizador de la reunión el número de invitados para reuniones que excedían el límite de la reunión.
-   Se ha corregido  un problema en el que el número de teléfono no se mostraba en las notificaciones sobre llamadas RTC entrantes.
-   Se ha corregido  un problema en el que, cuando se usaba la tecla Supr mientras se cambiaba el nombre de un grupo de la lista de contactos, se eliminaba todo el grupo.
-   Se ha corregido un problema en el que se descartaba la notificación para compartir de una conversación de mensajería instantánea antes de que se dejara de compartir.
-   Se ha corregido  un problema que causaba que la pantalla de inicio de sesión se mostrara en blanco para algunos idiomas distintos del inglés.
-   Se ha corregido un problema que causaba que los caracteres que no pertenecieran al alfabeto inglés aparecieran ilegibles en el chat y en el historial de chat.
...
-   Agrega una configuración de banda que permite la restricción de "Cualquiera (sin restricciones)" como una opción para "Estas personas no tienen que esperar en el vestíbulo".
-   Agrega capacidad de activar o desactivar auto vídeo para videollamadas P2P en VDIv2.
-   Se ha corregido un problema que mostraba los números duplicados de contactos en el menú desplegable para llamar.
-   Se ha corregido un problema que quitaba los delegados para los usuarios que se movían entre Skype for Business y Skype for Business Basic.
-   Se ha corregido un problema en el que el estado Sin conexión no era visible al usar las directivas de cliente Habilitar desconectado y URL de estado de cliente.
-   Se ha ampliado el botón Unirse a la reunión para corregir un truncamiento en algunos de los idiomas localizados.
-   Se ha aumentado la relevancia de los mensajes de importancia alta en el chat.
-   Se agregan tipos de extensión de archivo de Skype for Business y de Office a las listas de transferencias de archivos bloqueadas permitidas.
-   Se aplican correcciones de localización en las invitaciones a reuniones de Outlook para el texto del pie de página establecido en un idioma diferente al inglés en las reuniones.
-   Se ha corregido un problema que provocaba que los nombres de los remitentes se cambiaran a veces en las conversaciones de varios usuarios.
-   Se ha corregido un problema que provocaba que la ventana de conversación en blanco no apareciera hasta que no se había unido correctamente a una reunión.
-   Se ha corregido un problema que provocaba que la información del campo del departamento de una tarjeta de contacto no apareciera en los resultados de la búsqueda si el campo del título estaba vacío.
-   Se han corregido los errores de inicio de sesión de los usuarios migrados de un entorno local a uno en línea que se producían a causa de las reglas de firewall.
...
-   Se ha corregido un problema en el que los complementos COM no recibían eventos abiertos de un documento al abrir un archivo de Visio mediante un doble clic en un icono de archivo o nombre de archivo.
...
-   **Actividad de archivo compartido:** elija el botón Actividad en la esquina superior derecha del archivo para ver cuando un archivo compartido en OneDrive para la Empresa o SharePoint se compartió, se editó, se restauró o se cambió de nombre.
-   **Vínculos seguros:** cuando un usuario hace clic en un vínculo, Protección contra amenazas avanzada (ATP) de Office 365 lo inspecciona para comprobar si es malintencionado o no. Si el vínculo se considera malintencionado, se redirige al usuario a una página de advertencia en vez de redirigirlo a la URL de destino original. [Más información](https://support.office.com/article/dd6a1fef-ec4a-4cf4-a25a-bb591c5811e3)
-   **Cambios en archivos compartidos:** vea quién ha realizado cambios en los documentos compartidos y restaure versiones anteriores. [Más información](https://support.office.com/article/5c1e076f-a9c9-41b8-8ace-f77b9642e2c2)
...
### <a name="word-non-security-updates"></a>Word: actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema que provocaba que Word se bloqueara cuando un usuario usaba "Guardar como" con un documento existente en OneDrive para la Empresa y, seguidamente, cancelaba o intentaba combinar cambios existentes.
-   Se ha corregido un problema que causaba que Office no pudiera escribir en el disco al guardar un archivo de copia de sincronización, pero Office siguiera subiendo el archivo a OneDrive. Con esta corrección, ahora el usuario ve un mensaje de error y la subida no se realiza.
...
-   Se ha corregido un problema por el que, después de hacer clic en el margen, los caracteres se mostraban en la esquina superior izquierda de la pantalla al escribir caracteres.
-   Se ha corregido un problema por el que Word se bloqueaba al mostrar el panel Actividad de un documento abierto desde un servidor de SharePoint anterior a SharePoint Server 2016.
-   Se ha corregido un problema por el que Word se cerraba de forma inesperada al cargar el complemento Grammarly.
-   Se ha corregido un problema en el que, en determinadas condiciones, Word se bloqueaba al intentar recuperar los archivos en la nube.
...
-   Se ha agregado una función para impedir que usuarios menores de edad puedan comprar y activar complementos de Office de la Tienda Office.
-   Se ha corregido un problema relacionado con el zoom y el ajuste de escala en Complementos de Office en el entorno de PPP dinámico.
-   Se ha corregido un problema que causaba que el nodo CurrentStatus del proveedor del servicio de configuración (CSP) de Office devolviera una cadena vacía incluso si Office 365 ProPlus estaba instalado.
-   Se ha corregido un problema que provocaba cambios de formato en los archivos .box, lo que afectaba a la funcionalidad de las versiones antiguas de Office instaladas en el mismo equipo, ya que los archivos .box se comparten con todas las versiones de una aplicación de Office en el mismo equipo.
-   Se ha corregido un problema por el que, al usar la activación en equipos compartidos, en determinadas circunstancias se mostraba un mensaje de error donde se indicaba que un error en la aplicación impedía el correcto funcionamiento y se preguntaba al usuario si quería ejecutar una reparación.
-   Se ha corregido un problema por el que no se mostraba al usuario el progreso de una reparación en línea.
-   Se ha corregido un problema por el que no se muestran las propiedades de archivo de Office en el Explorador de archivos.
-   Se ha corregido un problema por el que los botones de complementos de Office desaparecen de la cinta de opciones cuando hay un segundo documento abierto.
-   Se ha corregido un problema por el que no se pueden abrir algunos módulos VBA que tienen nombres con caracteres de doble byte.
-   Se ha corregido un problema que impedía que se mostrara el cuadro de diálogo Novedades.
-   Se ha corregido un problema en el que al hacer clic en la pestaña Dibujo, se bloqueaba la aplicación para algunos usuarios.
-   Se ha corregido un problema en el que al mantener el puntero sobre un Control común que tiene una información sobre herramientas en él, hace que la aplicación se bloquee.
-   Se ha corregido un problema en el que un mensaje de error de licencia aparece cuando se usan controles comunes.
-   Se ha corregido un problema relacionado con la forma en que se firmaban algunos archivos de programa, lo que causaba que los programas antivirus marcaran esos archivos como potencialmente peligrosos, así como otros problemas de protección o acceso a datos en Windows Information Protection (WIP).
-   Se ha agregado compatibilidad para que los usuarios que trabajen en versiones de Office de 64 bits puedan abrir archivos de macro que contengan controles mscomctl.ocx.
-   Se han mejorado los controles de accesibilidad que se usan en mscomctl.ocx.
-   Se ha corregido un problema que provocaba que los comandos no estuvieran disponibles en los cuadros de diálogo de personalización de la cinta de opciones o de la barra de herramientas de acceso rápido.
