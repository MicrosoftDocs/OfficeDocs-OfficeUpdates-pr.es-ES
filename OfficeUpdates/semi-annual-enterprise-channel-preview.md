...
- Se ha solucionado un problema en Wordmail por el que no se puede enviar un artículo cuando el carácter 2084 de un enlace es un carácter de escape.


### <a name="office-suite"></a>Conjunto de aplicaciones de Office

- Se ha corregido un problema en el que las plantillas de Office se activaron incluso con la solicitud de deshabilitación de GPO.
...
- Soluciona un problema con los colores aplicados a los efectos en 3D y a los gráficos SVG.
...
- Se está corrigiendo un problema que hacía que copiar y pegar en los mensajes de Skype Empresarial hacía que se mostrara el siguiente aviso: "Se ha producido un error al pegar el contenido".


- Se ha corregido un problema que provocaba que se produjera un error al copiar o pegar texto de un comentario en Excel.


- Corrige un bloqueo al usar un narrador sin un texto con ecuaciones matemáticas.
