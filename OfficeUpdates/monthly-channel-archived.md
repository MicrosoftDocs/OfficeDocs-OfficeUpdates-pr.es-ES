...
ms.locfileid: "52278037"
---
# <a name="archived-release-notes-for-monthly-channel"></a>Notas de la versión archivadas para el canal mensual
...
## <a name="version-2011-december-21"></a>Versión 2011: 21 de diciembre
*Versión 2011 (compilación 13426.20404)*
...
- Se solucionó un problema que impedía que se abriera un archivo como NO SyncBacked cuando la dirección URL de la memoria caché y la dirección URL de OneDrive NO coincidían.
...
- Se ha corregido un error de aserción expuesto por puertas optimizadas que afectan a Word.
...
- **Plantillas en Microsoft Teams:** con plantillas en Teams, los usuarios pueden elegir entre una variedad de plantillas personalizables al crear un nuevo equipo, lo que les ayuda a empezar con rapidez. Asimismo, los profesionales de TI pueden crear nuevas plantillas personalizadas para su organización, lo que les permite normalizar estructuras de equipo, mostrar aplicaciones relevantes y escalar procedimientos recomendados.

- **Publicaciones ancladas:** esta característica permite a los usuarios "anclar" cualquier mensaje de un canal en el panel de información del canal para que todos los miembros del canal puedan verlo. Todos los usuarios que tengan acceso al canal podrán ver los mensajes anclados. Todos los miembros de un canal podrán anclar cualquier mensaje (a menos que esta opción se haya desactivado en la configuración de moderación de canales).

- **Enviar al catálogo de aplicaciones:** verá el vínculo Enviar al catálogo de aplicaciones en la esquina inferior izquierda de esta pantalla. Además de App Studio y Visual Studio, es otro lugar en el que puede enviar aplicaciones para aprobación.

- **Use Freehand de Invision para representar en la pizarra la experiencia de reunión emergente:** ya puede usar la aplicación Freehand de Invision para representar en la pizarra cualquier reunión que adopte en la experiencia de reunión emergente. Para iniciar la lluvia de ideas de manera sencilla, seleccione la aplicación Freehand en la bandeja Compartir contenido, instálela y comience la sesión de pizarra con sus compañeros.
...
- Se ha corregido un problema que hacía que Outlook creara una segunda firma vacía para las personas que tuvieran habilitada la configuración de la nube.
...
## <a name="version-2009-september-28"></a>Versión 2009: 28 de septiembre
...
- **Expansión automática de la búsqueda de archivos en línea:** Permite ampliar automáticamente la búsqueda de archivos en línea

- **Nueva tarjeta de perfil para Outlook:** Nueva tarjeta de perfil para Outlook en la que se muestra una vista mejorada de la Organización y que coincide con el estilo de tarjeta de Outlook Web.

### <a name="teams"></a>Teams

- **Compartir archivos en Microsoft Teams:** [Obtener más información](/MicrosoftTeams/sharing-files-in-teams)
...
- Corrige un problema que causaba que algunos mensajes de correo electrónico generados automáticamente se enviaran con el cuerpo en blanco cuando la línea de asunto está en blanco.
...
- Este cambio resuelve un problema relacionado con la característica exportar a GIF animado, en la que no se exporta al hacer clic en el botón exportar.
...
## <a name="version-2007-august-11"></a>Versión 2007: 11 de agosto
...
## <a name="version-2006-july-14"></a>Versión 2006: 14 de julio
...
- **Nombres de archivo más largos:** Excel para el escritorio de Windows ahora admite que los archivos de OneDrive/SharePoint tengan nombres y rutas de hasta 400 caracteres.
...
- **Los números de teléfono del participante RTC se le ocultan a usuarios externos:** para los clientes con las conferencias de audio habilitadas en sus reuniones de Teams, ocultaremos el número de teléfono del participante RTC para los usuarios que se hayan unido desde afuera de su organización.

- **Una manera simplificada de administrar la configuración de notificaciones su canal:** a través de la lista de equipos y canales o desde encabezado del canal, los usuarios pueden administrar rápidamente la configuración de notificaciones activando y desactivando la actividad con un solo clic o profundizando en la personalización para establecer las permutaciones preferidas.

- **Walkie-talkie:** comunicación de voz instantánea con el uso de pulsar para hablar.
...
- Se ha corregido este error, ahora es posible llamar al tipo de datos extendidos fecha/hora en el código sin experimentar bloqueos en la aplicación. Comuníquele al equipo si encuentra otros problemas.


- Se ha corregido este error; ahora puede volver a la versión de Access más actualizada y usar DAO/VBA para administrar y editar un tipo de datos decimal. Comuníquele al equipo de Access si encuentra algún otro problema al usar nuestro tipo de datos.
...
## <a name="version-2005-june-02"></a>Versión 2005: 2 de junio
...
- **Cambios en el diseño de vídeo en las reuniones de Teams:** próximamente, el número de participantes que se pueden ver simultáneamente durante una reunión de Teams aumentará de 4 a 9.

- **Incluya el audio del sistema en eventos en directo:** los moderadores y productores de eventos en directo ahora pueden incluir el audio del sistema al compartir la pantalla de escritorio o de ventana durante el evento en directo. Esto permite a los usuarios escuchar cualquier pieza de audio del contenido que se está compartiendo.

- **Se permite que los organizadores cambien la configuración de la sala de espera para los participantes con acceso telefónico:** esta opción controla si las personas que llaman por teléfono se unen la reunión directamente o aguardan en la sala de espera independientemente de la configuración de admitir participantes automáticamente.

- **Levante la mano en las reuniones:** ¡los usuarios ahora pueden levantar una mano virtual en una reunión! El resto de los participantes verán la mano levantada al lado del nombre en la fase de reunión y junto a su nombre en la lista de participantes.

- **Personalice los fondos de vídeo de la reunión:** cuando esté en una reunión con vídeo, ahora tiene la opción de usar distintas imágenes de fondo estáticas. Esto le permitirá mostrar esa imagen en lugar del fondo real del lugar donde está sentado.

- **Agregue más personas para conversar:** hicimos posible que ahora se puedan agregar hasta 350 personas a un solo hilo de conversación.

- **Icono de configuración en la fuente de actividades:** los usuarios ahora pueden acceder directamente a la fuente de actividades y la configuración de notificaciones desde la guía de la izquierda de la fuente mediante un engranaje de configuración.

- **Obtenga acceso fácilmente a las opciones de reunión desde una reunión de Teams en curso:** estamos haciendo más fácil para los organizadores de reuniones cambiar las configuraciones del moderador y la sala de espera una vez que se inicia una reunión de Teams, mediante un vínculo de acceso sencillo directamente en el panel participantes. Esta nueva funcionalidad estará disponible tanto para las reuniones programadas como para las de la opción "Reunirse ahora".

- **Análisis de equipo y canal:** además del análisis de equipo, ahora también puede ver métricas y perspectivas de nivel de canal. También ampliamos el período de tiempo a 90 días para que pueda analizar los datos durante períodos más largos. Adicionalmente, esta versión también incluye nuevas métricas y gráficos en torno al recuento de publicaciones, respuestas y reuniones para un equipo o canal.

- **Anuncios de entrada y salida:** agregamos esta característica que permite que los organizadores de reuniones puedan activar o desactivar anuncios de entrada y salida en una reunión.

### <a name="word"></a>Word

- **Descodificar acrónimos sin salir de Word:** cuando encuentre un acrónimo, Word intentará definirlo según el uso de otros usuarios.
...
- Se ha corregido un problema que provocaba que los usuarios de las versiones de Windows 10 Server vieran la advertencia "Estado del antivirus: no válido". Esta versión de Windows es compatible con la detección de antivirus, pero no se encontró ningún antivirus a pesar de tener uno correctamente instalado.
...
- Se ha corregido un problema de Hacer clic y ejecutar que provocaba errores de actualización ocasionales en las compilaciones más recientes.
...
- Corrige un problema que provocaba que los usuarios experimentaran un bloqueo al mostrar las notificaciones del sistema.
...
- **Vínculo a la diapositiva:** Pídale a un compañero que participe en la presentación de diapositivas y llévelo directamente a la diapositiva con la que necesita ayuda.
...
- Se corrigió un problema que provocaba que el evento OnUndoOrRedo no se activara sin antes ejecutar el método OpenUndoTransaction.
...
## <a name="version-1911-december-03"></a>Versión 1911: 3 de diciembre 
*Versión 1911 (compilación 12228.20332)*
...
- **Escriba una fórmula que devuelva varios valores:** Escriba rápidamente una fórmula que devuelva múltiples valores y se derramarán automáticamente en las celdas vecinas. [Más información](https://support.office.com/article/5c2c9cbb-def8-409a-b380-2fbf91b20aa3)
...
- Arreglado un problema en Microsoft Access que podía causar el error &quot;Consulta dañada&quot; cuando se ejecuta una consulta de actualización o se utiliza una instrucción UPDATE en SQL.
...
- Se ha corregido un problema que provocó que el campo ubicación en las reuniones se actualizara de forma inesperada.
...
## <a name="version-1910-november-22"></a>Versión 1910: 22 de noviembre
*Versión 1910 (compilación 12130.20410)*
* Varias correcciones de errores y rendimiento.

## <a name="version-1910-november-18"></a>Versión 1910: 18 de noviembre
*Versión 1910 (compilación 12130.20390)*
...
## <a name="version-1910-november-12"></a>Versión 1910: 12 de noviembre
*Versión 1910 (compilación 12130.20344)*
...
- Abordado un problema que causó un bloqueo en la experiencia de búsqueda de comentarios.
...
- **Instalar Microsoft Teams en instalaciones existentes de Office 365 ProPlus:** a partir de finales de junio, Microsoft Teams se incluirá en las instalaciones existentes de Office 365 ProPlus (y Office 365 Empresa) cuando se actualicen estas instalaciones. La fecha en la que se agregará Teams depende del canal de actualización que use. Para obtener más información, consulte implementar Microsoft Teams con Office 365 ProPlus. [Más información](/deployoffice/teams-install)
...
### <a name="project"></a>Proyecto
- Se resolvió un problema por el que los usuarios podían obtener varios mensajes al abrir un proyecto de sólo lectura.

### <a name="office-suite"></a>Conjunto de aplicaciones de Office

- Para proteger la seguridad de los clientes de Office, las actualizaciones de Microsoft Office se firman ahora utilizando exclusivamente el algoritmo SHA-2.<br>
...
### <a name="office-suite"></a>Conjunto de aplicaciones de Office
- Hemos desactivado el cuadro de diálogo Guardar en la nube de forma temporal para solucionar el problema de almacenamiento que publicamos el 14 de octubre de 2019 de las compilaciones posteriores a la versión 12130.20184. Esta característica se volverá a habilitar próximamente.
...
- **Repetición de entrada de lápiz:** anime un dibujo para que se reproduzca hacia adelante o hacia atrás durante la presentación con diapositivas. [Más información](https://support.office.com/article/fa4f044f-810b-43fe-b774-da04a0b37496)

- **Uso compartido de archivos más rápido:** comparta sus documentos directamente desde la lista usada recientemente sin tener que abrir el archivo.

### <a name="visio"></a>Visio

- **Diseñar y automatizar flujos de trabajo empresariales con Microsoft Flow y Visio:** diseñe diagramas de flujo de trabajo con Visio y expórtelos a Microsoft Flow para automatizarlos.
...
- **Diga adiós a las distracciones:** llega a Windows una de las característica favoritas de Mac. Cambie al modo Focalizado en el menú Vista para eliminar las distracciones y concentrarse en su trabajo. [Más información](https://support.office.com/article/51af2fb2-194f-424b-ab7e-b65de9ec9292)
...
- Corrige un problema que causaba que un subconjunto de usuarios de POP3 viesen todos los correos electrónicos como texto sin formato, independientemente de la configuración.  En esta corrección se restaurará la vista de los mensajes con formato HTML.

## <a name="version-1906-june-26"></a>Versión 1906: 26 de junio
*Versión 1906 (compilación 11727.20224)*
...
- Se ha resuelto un problema que provocaba errores en las operaciones de corte y pegado junto a una tabla cuando se trabajaba en coautoría con otras personas.

### <a name="outlook-non-security-updates"></a>Outlook: actualizaciones no relacionadas con la seguridad

- Corrige un problema que causaba ambigüedad para los administradores sobre si un delegado ya había respondido a una convocatoria de reunión determinada.
...
- **Coautoría:** ¿está cansado de no tener acceso a documentos que contienen macros? Ahora, los archivos docm de OneDrive para la Empresa permiten la edición simultánea de varios autores.

### <a name="skype-for-business-non-security-updates"></a>Skype Empresarial: actualizaciones no relacionadas con la seguridad 

 - Corrección para mostrar todas las transmisiones de cámara de Polycom CX5500 y dispositivos relacionados en una reunión cuando el monitor tiene una escala superior al 100%.
...
- Permitir la transferencia de archivos a clientes heredados de Office Communicator desde un equipo con Windows 10 con varios adaptadores de red.

- Experiencia mejorada para la comunicación entre los participantes de Skype Empresarial y Microsoft Teams.


## <a name="version-1905-june-11"></a>Versión 1905: 11 de junio
*Versión 1905 (compilación 11629.20246)*
<br/>Las actualizaciones de seguridad se muestran [aquí](./microsoft365-apps-security-updates.md)
...
## <a name="version-1905-june-3"></a>Versión 1905: 3 de junio
...
- **Colabore de forma más eficaz con @menciones en comentarios:** la colaboración se ha vuelto mucho más fácil. Ahora puede @mencionar a sus compañeros en los comentarios de documentos y recibirán automáticamente una notificación por correo electrónico que les dirigirá al documento.

- **Mejoras en la combinación de coautoría:** la coautoría ha mejorado la tasa de éxito de combinación al trabajar con formato condicional, estilos de celda, protección de rango, visualización de líneas de cuadrícula y el corte/pegado entre hojas. 
...
- **Transcripción y subtítulos en directo:** las palabras del moderador se muestran automáticamente en la pantalla como subtítulos o se traducen en el idioma que prefiera. [Más información](https://support.office.com/article/d68d20e49-aec3-456a-939d-34a79e8ddd5f)
...
- Se ha corregido un problema que provocaba que el asunto apareciera en un tamaño demasiado pequeño.
...
## <a name="version-1903-april-23"></a>Versión 1903: 23 de abril
*Versión 1903 (compilación 11425.20244)*

- Varias correcciones de errores y rendimiento.

## <a name="version-1903-april-17"></a>Versión 1903: 17 de abril
*Versión 1903 (compilación 11425.20228)*

- Varias correcciones de errores y rendimiento.

## <a name="version-1903-april-16"></a>Versión 1903: 16 de abril
*Versión 1903 (compilación 11425.20218)*
...
## <a name="version-1901-january-31"></a>Versión 1901: 31 de enero
*Versión 1901 (compilación 11231.20130)* 
...
-   [CVE-2018-8546](https://portal.msrc.microsoft.com/es-ES/security-guidance/advisory/CVE-2018-8546): vulnerabilidad de la denegación de servicio de Microsoft Skype Empresarial 
 ...
 - Corregido un problema por el que al guardar o publicar un proyecto en Project Online, la barra de estado no se actualizaba siempre para mostrar el último estado.
...
- **Edición sencilla en la barra de fórmulas:** ahora, puede usar CTRL + A para seleccionar el texto de una celda o de la barra de fórmulas. También se ha mejorado la compatibilidad con los emojis y otros caracteres complejos. [Más información](https://support.office.com/article/402d8c2a-354c-4690-bacf-1c319c4ec2fb)
...
- **Mostrar lo que esconde una imagen:** coloque una imagen en una diapositiva, elija el valor predeterminado y vea cómo cambia la transparencia. [Más información](https://support.office.com/article/ea62f9bf-f0ee-4b64-bcc5-c49275bf350d)
- **Nuevas herramientas de revisión:** no se preocupe de las palabras. Ahora en PowerPoint se ofrecen sugerencias de gramática y escritura.
...
- **Cambie su documento de estático a impresionante** Transforme el documento en una página web interactiva y fácil de compartir con un aspecto fantástico en cualquier dispositivo. [Más información](https://support.office.com/article/65912b2d-8b81-41e1-ac52-c20a65ce8ecf)
...
### <a name="visio-feature-updates"></a>Visio: actualizaciones de características
 ...
 - **Visio y Power BI: mejor juntos** En unos pocos clics, convierta el diagrama de Visio en una visualización interactiva de Power BI. [Más información](https://support.office.com/article/4f09be62-f436-45c2-93b0-4a0f66b1f5a7)
...
### <a name="outlook-non-security-updates"></a>Outlook: Actualizaciones no relacionadas con la seguridad
 - Se ha solucionado un problema que provocaba que el vínculo "Haga clic para ver más..." no apareciera en la lista de resultados de la búsqueda para algunos usuarios con varias cuentas de Exchange configuradas.
...
### <a name="lync-non-security-updates"></a>Lync: Actualizaciones no relacionadas con la seguridad
 - Se ha corregido un problema que impedía que se mostraran emoticonos en los mensajes de mensajería instantánea. 
...
### <a name="project-non-security-updates"></a>Project: Actualizaciones no relacionadas con la seguridad
 - Se ha corregido un problema que provocaba que no se pudieran guardar los subproyectos de los proyectos principales.

### <a name="visio-feature-updates"></a>Visio: Actualizaciones de características
 - **Más galerías de símbolos, más iconos, más opciones:** hemos agregado 26 galerías de símbolos entre las que se incluyen las siguientes: Análisis, Artes, Celebración, Caras, Ubicación, Medicina, Naturaleza, Personas, Deportes, El tiempo, Temporadas, etc.
...
## <a name="version-1805-may-23"></a>Versión 1805: 23 de mayo
*Versión 1805 (compilación 9330.2078)*
...
### <a name="project-non-security-updates"></a>Project: Actualizaciones no relacionadas con la seguridad
 - Se soluciona un problema que provocaba que Project se bloqueara la primera vez que se guardaba un proyecto en Project Web App.
...
### <a name="word-feature-updates"></a>Word: Actualizaciones de características
 - **Chatear con coautores al editar:** colabore de forma más eficaz chateando con los coautores sin salir de Word. [Más información](https://support.office.com/article/1ecc6c7f-0b02-4baa-b9d9-c9d67023bedd)
...
## <a name="version-1804-may-14"></a>Versión 1804: 14 de mayo
*Versión 1804 (compilación 9226.2156)*

### <a name="office-suite-non-security-updates"></a>Conjunto de aplicaciones de Office: Actualizaciones no relacionadas con la seguridad
- Se soluciona un problema que provocaba que, al abrir una aplicación, el usuario viera un mensaje sobre iniciar en modo seguro y después la aplicación no se abriera.
...
## <a name="version-1804-april-25"></a>Versión 1804: 25 de abril
...
## <a name="version-1802-february-26"></a>Versión 1802: 26 de febrero
*Versión 1802 (compilación 9029.2167)*
...
-   **Más galerías de símbolos para diagramas empresariales:** Utilice formas modernas para comparar y contrastar datos con un diagrama de Venn, o bien dibujar diagramas piramidales, de ciclo o de matrices para proporcionar la información correspondiente.
...
## <a name="version-1801-february-1"></a>Versión 1801: 1 de febrero
*Versión 1801 (compilación 9001.2138)*

### <a name="project-non-security-updates"></a>Project: Actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema por el que el trabajo real aún se mostraba en las tablas de informe después de quitarlo de una sesión Guardar para compartir.
...
-   Se ha corregido un problema donde "Forma del punto de progreso" se dibujaba en una ubicación inesperada.

### <a name="skype-for-business-non-security-updates"></a>Skype Empresarial: Actualizaciones no relacionadas con la seguridad
-   Se ha corregido un problema por el que los botones "Más opciones" y "Invitar a más personas" se ocultaban cuando una reunión estaba en modo de pantalla completa.
...
### <a name="visio-feature-updates"></a>Visio: Actualizaciones de características
-   **Usar plantillas de Excel para exportar a un diagrama de Visio:** Tome la ventaja en el uso de diagramas de flujo de Visio. Agregue los datos a una de las plantillas de Excel de mapa de proceso y exporte el contenido a Visio para crear automáticamente el diagrama. Requiere Visio Pro para Office 365.
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint: Actualizaciones no relacionadas con la seguridad
-   Se soluciona un problema por el que, al quitar las propiedades y la información personal de un documento, se producía un error al guardar en SharePoint.

### <a name="project-non-security-updates"></a>Project: Actualizaciones no relacionadas con la seguridad
-   Se soluciona un problema por el que se perdía código VBA de proyectos.
