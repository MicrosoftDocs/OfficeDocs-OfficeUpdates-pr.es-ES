...
*Esta es la versión de canal aplazado que ha estado disponible desde junio de 2017. Continuará ser compatibles y recibir actualizaciones de seguridad hasta de 2018 de enero. Pero ahora está disponible una nueva versión de canal aplazado: 1705 versión (compilación 8201.2213), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
-   Se ha corregido un problema con la versión de 64 bits de Office que causaba que las aplicaciones de Office se bloqueasen,por ejemplo, cuando el usuario iniciaba sesión en Archivo \> Opciones.
...
*Esta es la versión de canal aplazado que ha estado disponible desde junio de 2017. Continuará ser compatibles y recibir actualizaciones de seguridad hasta de 2018 de enero. Pero ahora está disponible una nueva versión de canal aplazado: 1705 versión (compilación 8201.2207), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
*Esta es la versión de canal aplazado que ha estado disponible desde junio de 2017. Continuará ser compatibles y recibir actualizaciones de seguridad hasta de 2018 de enero. Pero ahora está disponible una nueva versión de canal aplazado: 1705 versión (compilación 8201.2200), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
### <a name="excel-non-security-updates"></a>Excel: Actualizaciones no relacionadas con la seguridad
-   Se han solucionado los problemas que se producían al copiar y pegar contenido en Excel. Por ejemplo, se ignoraba el texto HTML separado por tabulaciones, se eliminaban incorrectamente las filas y columnas vacías y se ignoraban la alineación y las fórmulas.
...
-   Se ha solucionado un problema que bloqueaba Excel cuando se agregaban datos de hojas de cálculo a un modelo de datos y se establecía el tema de contraste alto en negro.
-   Se ha solucionado un problema por el que Excel se bloqueaba con los libros que contenían vínculos externos.
...
-   Se ha solucionado un problema que provocaba que en Excel no se estableciese la contraseña de protección de hojas cuando se aplicaba mediante programación en libros creados en Excel 2010 o versiones anteriores.
...
-   Se ha solucionado un problema en el que se producía un error de mezcla al agregar una forma después de que otro usuario cambiase el diseño.
...
-   Se ha solucionado un problema por el que se imprimía la dirección de entrega en sobres demasiado cerca del borde izquierdo.
-   Se ha solucionado un problema por el que las tablas no se mostraban adecuadamente después de realizar determinadas acciones.
...
*Esta es la versión de canal aplazado que ha estado disponible desde junio de 2017. Continuará ser compatibles y recibir actualizaciones de seguridad hasta de 2018 de enero. Pero ahora está disponible una nueva versión de canal aplazado: 1705 versión (compilación 8201.2193), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
*Esta es la versión de canal aplazado que ha estado disponible desde febrero de 2017. Continuará ser compatibles y recibir actualizaciones de seguridad hasta septiembre de 2017. Pero ahora está disponible una nueva versión de canal aplazada — versión 1701 (compilación 7766.2096), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
-   Se soluciona un problema por el que el usuario ve un nuevo tipo de almacén de "Microsoft Exchange" en el cuadro de diálogo "Nuevo archivo de datos de Outlook" y, si se selecciona este nuevo tipo de datos, el perfil del usuario no se puede usar
-   Se soluciona un problema en el que, cuando se hace clic con el botón derecho en un archivo adjunto en la lista de archivos adjuntos de una conversación, todos los elementos de menú contextual están visibles, en lugar de solo los elementos de menú correspondientes.
...
### <a name="powerpoint-non-security-updates"></a>PowerPoint: Actualizaciones no relacionadas con la seguridad
-   Se soluciona un problema en el que al agregar diapositivas desde otras plantillas durante las sesiones de co-autoría de PowerPoint se puede producir un error.
...
*Esta es la versión de canal aplazado que ha estado disponible desde febrero de 2017. Continuará ser compatibles y recibir actualizaciones de seguridad hasta septiembre de 2017. Pero ahora está disponible una nueva versión de canal aplazada — versión 1701 (compilación 7766.2092), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
*Esta es la versión de canal aplazado que ha estado disponible desde octubre de 2016. Continuará ser compatibles y recibir actualizaciones de seguridad hasta junio de 2017. Pero ahora está disponible una nueva versión de canal aplazado: versión 1609 (compilación 7369.2130), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
*Esta es la versión de canal aplazado que ha estado disponible desde octubre de 2016. Continuará ser compatibles y recibir actualizaciones de seguridad hasta junio de 2017. Pero ahora está disponible una nueva versión de canal aplazado: versión 1609 (compilación 7369.2127), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
*Esta es la versión de canal aplazado que ha estado disponible desde octubre de 2016. Continuará ser compatibles y recibir actualizaciones de seguridad hasta junio de 2017. Pero ahora está disponible una nueva versión de canal aplazado: versión 1609 (compilación 7369.2120), que contiene las nuevas características, actualizaciones de seguridad y las actualizaciones de seguridad que no sean.*
...
-   Se soluciona un problema en el que, al personalizar el tamaño de la diapositiva, la traducción al tailandés de la abreviatura de "pulgadas" es incorrecta.
